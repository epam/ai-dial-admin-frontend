...
Defines how the test suites list grid surfaces suite type, distinguishing DEPLOYMENT and MCP_TOOL suites through a dedicated column and through the existing Application column's fallback behavior.
