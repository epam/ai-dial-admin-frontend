...
The `CONTAINER_SOURCE_TYPE.IMAGE_REFERENCE` enum value SHALL be defined. No UI flow SHALL be implemented for creating containers with `image_reference` source.
