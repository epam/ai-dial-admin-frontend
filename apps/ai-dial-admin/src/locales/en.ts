export default {
  ...
  AnalyticsPipelines: {
    ...
    SectionScope: 'Scope',
    Filter: 'Filter',
    FilterCaption: 'Rows the pipeline considers. Empty means every row.',
    SourceFollow: 'Follow target enrichment',
    SourceFollowCaption: 'Following tracks the target’s source. Pinning holds one table.',
    ...
    Trigger: 'Trigger',
    GrainKey: 'Grain key',
    GrainKeyHint: 'The target table’s grain key. A group trigger groups rows by it.',
    ...
    ClampedBy:
      'This pipeline has already read everything {enrichment} has written. It goes further on its own once {enrichment} writes more.',
    RebuildRequiredTitle: 'Rebuild needed',
    RebuildRequired:
      '{enrichment} was rebuilt after this pipeline last wrote its output, so what this pipeline holds no longer matches it.',
    LastErrorTitle: 'Last run failed',
