export default {
  ...
  QueryBuilder: {
    ...
    SavedQueriesMy: 'My queries',
    SavedQueriesCommon: 'Common',
    SavedQueriesSearch: 'Search saved queries',
    SavedQueriesOpen: 'Open query',
    SavedQueriesNoMatches: 'No saved queries match your search.',
    SavedQueriesUntagged: 'Untagged',
    SavedQueriesPreviewEmpty: 'Select a query to preview it.',
    SavedQueriesEmptyPersonalTitle: "You haven't saved a query yet",
    SavedQueriesEmptyPersonalDescription: "Build one, then save it — it'll be here next time.",
    SavedQueriesEmptyCommonTitle: 'No common queries yet',
    SavedQueriesEmptyCommonDescription: 'Queries your team agrees are worth keeping.',
    SavedQueriesFooterPersonal: 'Your saved queries · {count}',
    SavedQueriesFooterCommon: 'Common library · {count}',
    SavedQueriesLoadFailed: 'Could not load saved queries.',
    SavedQueryTag: 'Tag',
    SavedQueryPeriod: 'Period',
    SavedQueryPeriodRelative: '{period} (relative)',
    SavedQueryPeriodAbsolute: '{from} — {to}',
    SavedQueryPeriodNotSaved: 'Not saved with the query',
    SavedQueryShowsAs: 'Shows as',
    SavedQueryShowsAsChart: '{type} chart',
    SavedQuerySavedBy: 'Saved by',
    SavedQueryAuthorUnknown: 'Author not recorded',
    SavedQueryBody: 'Query',
    SavedQueryDiscardPrompt: 'Opening this discards your unsaved changes.',
    SavedQueryKeepEditing: 'Keep editing',
    SavedQueryDiscardAndOpen: 'Discard and open',
    SaveQuery: 'Save',
    SaveQueryTitle: 'Save query',
    SaveQueryAsNew: 'Save as new',
    SaveQueryAsNewTitle: 'Save as a new query',
    SavedQueryRenameTitle: 'Rename query',
    SavedQueryName: 'Name',
    SavedQueryNamePlaceholder: 'What this query answers',
    SavedQueryDescription: 'Description',
    SavedQueryDescriptionPlaceholder: 'When to use it, and what to read from it',
    SavedQueryTagPlaceholder: 'Optional — e.g. Adoption',
    SaveQueryDestination: 'Save to',
    SaveQueryDestinationPersonal: 'My queries',
    SaveQueryDestinationPersonalHint: 'Only you see it.',
    SaveQueryDestinationPersonalHintOpen: 'Saved to your own library.',
    SaveQueryDestinationCommon: 'Common library',
    SaveQueryDestinationCommonHint: 'Everyone sees it.',
    SaveQueryCaptureTime: 'Save the time period — {period}',
    SaveQueryCaptureTimeHintRelative:
      'Kept as a relative period, so reopening it runs the last {period} from then, not from today. Uncheck to use whatever period the toolbar has on open.',
    SaveQueryCaptureTimeHintAbsolute: 'Kept as a fixed range. Uncheck to use whatever period the toolbar has on open.',
    SaveQueryChart: 'Open as a chart, with this setup',
    SaveQueryChartHint: 'Uncheck to save the query and have it open as a table.',
    SaveQueryChartAxisDefault: 'default',
    SavedQueryNameRequired: 'Enter a name.',
    SavedQueryNameDuplicate: 'A query named "{name}" is already tagged {tag}.',
    SavedQueryMoreActions: 'More actions',
    SavedQueryRevert: 'Revert',
    SavedQueryDeleteTitle: 'Delete saved query?',
    SavedQueryDeleteDescription: 'This permanently deletes "{name}".',
    SavedQuerySaved: 'Query saved.',
    SavedQueryDeleted: 'Query deleted.',
    SavedQueryOpenFailed: 'Could not open the saved query.',
    SavedQueryErrorGeneric: 'Could not save the query.',
    SavedQueryErrorValidation: 'The service rejected this query.',
    SavedQueryErrorSensitiveLiteral:
      'A saved query cannot compare this column to a fixed value. Remove or change that condition to save it — or run this query from the builder without saving.',
    SavedQueryErrorForbidden:
      'You need the full admin role to write to the common library. Save it to My queries instead.',
    SavedQueryErrorNotFound: 'This saved query no longer exists. The list has been refreshed.',
    SavedQueryErrorPrincipalUnavailable:
      'This query could not be saved because the service is not configured to identify you. This is a configuration problem — contact an administrator.',
    UnavailableFieldSingle: "{field} isn't a field in {source}. Remove it to run this query.",
    UnavailableFieldMultiple: "{count} fields aren't in {source}: {fields}. Remove them to run this query.",
    UnavailableFieldChip: "{field} isn't a field in {source}",
  },
  AnalyticsTables: {
  ...
  ConversationsTrace: {
    ...
    SearchPlaceholderWithTitles: 'Search conversations, projects and titles…',
    Feedback: 'Feedback',
    FeedbackAll: 'All',
    FeedbackPositive: 'Positive feedback',
    FeedbackNegative: 'Negative feedback',
    FeedbackRated: 'Rated',
    ProvenanceConversation: 'Conversation · enrichment',
    ProvenanceConversationHint:
      'Conversation id comes from dial_usage_log. Title and summary come from the conversation_summary enrichment, which is not live yet — these are sample values.',
    ProvenanceUsageLog: 'dial_usage_log',
    ProvenanceUsageLogHint: 'Aggregated from dial_usage_log rows in the selected period.',
    ...
    EntityPending: 'Not registered yet — these values are samples.',
    SummaryConversations: 'Conversations',
    SummaryRated: 'Rated',
    SummaryWith: 'With',
    SummaryCost: 'Cost',
    SummaryCostHint: 'Total cost of the conversations listed below, rounded for display.',
    SummaryScopeHint: 'Covers the conversations listed below.',
    SummaryTruncatedHint:
      'Covers the conversations listed below only. The result is capped at one page, so the totals are a lower bound.',
