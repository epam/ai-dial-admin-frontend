export default {
  ...
  QueryBuilder: {
    ...
    Mode: 'Mode',
    RowMode: 'Row',
    RowModeCaption: 'Projection',
    AggregateMode: 'Aggregate',
    AggregateModeCaption: 'Group + metrics',
    ...
    SchemaGridField: 'Field',
    SchemaGridType: 'Type',
    SchemaGridFamily: 'Family',
    SchemaGridSource: 'Source',
    SchemaGridTag: 'Tag',
    EntitiesLoadFailed: 'Could not load entities.',
    SchemaLoadFailed: 'Failed to load schema.',
    InstanceIdRequired: 'Enter an instance id to load the detailed schema.',
