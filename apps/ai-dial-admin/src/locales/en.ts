export default {
  ...
  TestSuites: {
    ...
    CasesPassedCaption: 'cases passed',
    CasePassRateLatestRun: 'Latest Run',
    CasePassRateInProgress: 'In progress',
    CasePassRateNotRun: '{count} not run',
    CasePassRateVsPrev: 'vs prev',
    CasePassRateLackScoring: 'Lack scoring',
    CasePassRateUnavailable: 'Case pass rate is unavailable.',
    CasePassRateBarLabel:
      'Run {run}, {date}: {passed} pass, {failed} fail, {errored} error, {notScored} not scored, of {total}',
