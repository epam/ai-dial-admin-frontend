export default {
  ...
  ConversationsTrace: {
    ...
    SpanSent: 'Sent',
    SpanReceived: 'Received',
    SpanToolCalls: 'Tools requested',
    SpanTextsLoading: 'Reading this hop…',
    SpanTextsNone: 'This hop recorded no readable request or response.',
    SpanTextsLoadFailed: 'This hop’s request and response could not be read.',
    SpanTextsNoResponse: 'This hop returned no response body.',
    SpanTextsSessionSetup: 'Session setup, not content — this hop negotiated the MCP session.',
    SpanTextsEmbedding: 'An embedding: the response is a vector, not text.',
