export default {
  ...
  Entities: {
    ...
    NoContainersType: 'No {type} Containers',
  ...
  Buttons: {
    ...
    Install: 'Install',
    Run: 'Run',
    CreateContainer: 'Create {type} Container',
    CreateEntity: 'Create {entity}',
    CreateEntityAsAsset: 'Create Assets {entity}',
    AddPort: 'Add Port',
  },
  Compare: {
  ...
  Containers: {
    'ContainersListTitle#zero': '{type} containers',
    'ContainersListTitle#other': '{type} containers: {count}',
    'RelatedContainersListTitle#zero': 'Related containers',
    'RelatedContainersListTitle#other': 'Related containers: {count}',
    CreateModalTitle: 'Creating {type} Container',
    AddModalTitle: 'Add {type} Container',
    DuplicateModalTitle: 'Duplicate {type} Container',
    DeleteModalTitle: 'Confirm Deleting {type} Container',
    DeleteModalDescription: 'Are you sure, you want to delete this Container?',
    Container: 'Container',
