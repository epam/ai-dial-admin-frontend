export default {
  ...
  AnalyticsPipelines: {
    ...
    OutputBindingsDiscarded: 'Without an output binding this pipeline computes results and stores none.',
    ...
    MeasureDistinct: 'Aggregate distinct values',
    ...
    AddMeasure: '+ Measure',
    Freshness: 'Freshness',
    FreshnessPeriodic: 'Periodic',
    FreshnessPeriodicCaption: 'Rebuilt on its schedule.',
    FreshnessIncremental: 'Incremental',
    FreshnessIncrementalCaption: 'Advances with its input as rows arrive.',
