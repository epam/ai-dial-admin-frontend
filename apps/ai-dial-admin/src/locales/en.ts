export default {
  ...
  UpdateEntity: {
    Notification: {
      ...
      TestCasesSavedSuffix: '{count} test case(s) saved.',
    },
    Entities: {
      Model: 'Model',
      Application: 'Application',
  ...
  Datasets: {
    ...
    PickPublic: 'Pick public dataset',
    CreatePrivate: 'Create private dataset',
    Unbind: 'Unbind',
    Visibility: 'Visibility',
    Public: 'Public',
    Private: 'Private',
    PrivateBoundLocked: 'Private datasets are permanently bound to their suite',
    NoDatasetBoundTitle: 'No dataset bound',
    NoDatasetBoundDescription:
      'Bind a dataset to manage test cases. Pick an existing public dataset or create a new private dataset for this suite.',
    PublicReadOnlyBanner: 'This dataset is shared and managed elsewhere — open the dataset to edit.',
    OpenDataset: 'Open dataset',
    MakePublic: 'Make public',
    MakePrivate: 'Make private',
    RevalidationInProgress: 'Revalidating test cases…',
    RevalidationCompleted: 'Revalidation completed',
