export default {
  ...
  Runs: {
    ...
    MetricScoresDescriptionAvgTurns: 'Average score among all scored test case turns',
    MetricScoresDescriptionP90Turns: 'Score higher than 90% of scored test case turns',
    MetricScoresDescriptionP10Turns: 'Score higher than 10% of scored test case turns',
    MetricScoresDescriptionMaxTurns: 'Highest score among all scored test case turns',
    MetricScoresDescriptionMinTurns: 'Lowest score among all scored test case turns',
    MetricScoresDescriptionMedTurns: 'Median score among all scored test case turns',
    MetricScoresDescriptionCountTurns: 'Number of scored test case turns',
    NoMetricScores: 'No metric scores available for this run.',
    DistributionTitle: 'Distribution',
    Metric: 'Metric:',
    DistributionValueTitle: 'test cases',
    DistributionValueTitleTurns: 'test case turns',
    SelectMetricToSeeDistribution: 'Select a metric to see its score distribution.',
    TestCasesPassed: 'Test Cases Passed Threshold',
    TestCaseTurnsPassed: 'Test Case Turns Passed Threshold',
    AvgTestCaseRunTime: 'Avg Test Case Run Time',
    AvgTestCaseTurnRunTime: 'Avg Test Case Turn Run Time',
    AvgPerTestCase: 'avg per test case',
    AvgPerTestCaseTurn: 'avg per test case turn',
    Pass: 'pass',
    Fail: 'fail',
    ExecError: 'error',
    Milliseconds: 'ms',
