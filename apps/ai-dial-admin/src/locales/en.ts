export default {
  ...
  AnalyticsPipelines: {
    ...
    NoEvaluatorsNote: 'No evaluators are registered. Register one through the API before creating an enrich pipeline.',
    ...
    MembersPlaceholderMissing:
      "This evaluator's request template references no {{members}}, which a group trigger requires: the rendered prompt would reach the model carrying none of the group. Pick another evaluator, or add the placeholder to this one.",
    Loading: 'Loading…',
    ...
    VariablesIn: 'What the evaluator receives',
    VariablesOut: 'Where its answer lands',
    VarName: 'Name',
    VarColumn: 'Column',
    ...
    MemberScopeTitle: 'Which members reach the evaluator',
  ...
  AnalyticsEvaluators: {
    ...
    AddOutput: '+ Variable',
    OutputNameDuplicate: 'Two outputs share this name. The request keys outputs by name, so one would be lost.',
    OutputsOrderHint:
    ...
    TemplatePlaceholders:
      'Placeholders the render fills in when a group-triggered pipeline runs this template. A pipeline that fires per row substitutes its own variables instead and refuses these names.',
    ...
    OutputVarsRequired: 'Declare at least one output.',
  ...
  AnalyticsUsage: {
    ...
    TimeSeriesCostSubtitle: 'Spend per {window} · last {count} · UTC',
    ...
    SearchNoMatches: 'Nothing matches “{term}”',
    RowIsNew: 'New',
