export default {
  ...
  Deployments: {
    ...
    NodePoolColumnName: 'Name / Instance',
    NodePoolColumnAccelerator: 'Accelerator',
    NodePoolColumnCpu: 'CPU',
    NodePoolColumnMemory: 'Memory',
    NodePoolColumnNodes: 'Nodes',
    NodePoolCpuOnly: 'CPU only',
    NodePoolEmpty: 'No node pools configured',
    NodePoolLoadError: 'Failed to load node pools',
    NodePoolUnitVram: 'VRAM',
    NodePoolUnitRam: 'RAM',
    NodePoolUnitNodes: 'nodes',
    NodePoolModalTitle: 'Select node pool',
    NodePoolSelect: 'Select node pool',
    NodePoolNotSelected: 'No node pool selected',
    NodePoolSearchPlaceholder: 'Search by name, GPU model, instance type…',
