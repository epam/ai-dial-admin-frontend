export default {
  ...
  QueryBuilder: {
    ...
    Functions: 'Functions',
    Columns: 'Columns',
    FnDateBinHint: 'time bucket',
    FnLowerHint: 'lowercase',
    FnUpperHint: 'uppercase',
    FnLengthHint: 'string length',
    FnTrimHint: 'trim whitespace',
    FnAbsHint: 'absolute value',
    Function: 'Function',
    Aggregate: 'Aggregate',
