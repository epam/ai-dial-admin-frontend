export default {
  ...
  QueryBuilder: {
    ...
    AiPanelDescription:
      'Describe what you want in plain language. The assistant maps it to entities and columns from the registry and loads a query here — you stay in control and can run it or tweak it in the SQL view.',
    AiPromptPlaceholder: 'e.g. Total cost by deployment last 7 days, most expensive first',
    AiGenerate: 'Generate query',
    AiGenerating: 'Generating…',
    AiProposedQuery: 'Proposed query',
    AiResponseLabel: 'Assistant response',
    AiRunHint: 'Loaded into the builder — switch to Builder, JSON, or SQL to view or edit it, or click Run above.',
