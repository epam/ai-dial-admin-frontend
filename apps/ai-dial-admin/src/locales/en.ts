export default {
  ...
  Menu: {
    ...
    PlatformTranslators: 'Translators',
    PlatformRoutes: 'Routes',
    PlatformRoles: 'Roles',
    PlatformKeys: 'Keys',
    PlatformAppRunners: 'App Runners',
    PlatformCatalogSchemas: 'Catalog Schemas',
    Routes: 'Routes',
  ...
  ModelView: {
    ...
    Pricing: {
      ...
      ConfigureConditional: 'Configure conditional rate',
      UseFlatRate: 'Use flat rate',
      PromptRate: 'prompt rate',
      FieldPlaceholder: 'Standard field or $path',
    },
    Chat: 'Chat',
    Embedding: 'Embedding',
  },
  ...
  Tabs: {
    ...
    RateLimitSchedule: 'Rate Limit Schedule',
    MCP: 'MCP',
  ...
  Publications: {
    ...
    Entities: {
      ...
      Toolset: 'Toolset Publication',
      Prompt: 'Prompt Publication',
      File: 'File Publication',
      Conversation: 'Conversation Publication',
      Skill: 'Skill Publication',
    },
    Notification: {
      DeleteTitle: '{entity} was deleted successfully.',
      DeleteDescription: '{entity} {entityId} has been deleted.',
      DeclineTitle: '{entity} was declined successfully.',
      DeclineDescription: '{entity} {entityId} has been declined.',
      PublishTitle: '{entity} was published successfully.',
      PublishDescription: '{entity} {entityId} has been published.',
      UnpublishTitle: '{entity} was unpublished successfully.',
      UnpublishDescription: '{entity} {entityId} has been unpublished.',
    },
  },
  Prompts: {
  ...
  EntityFields: {
    ...
    catalogEntityType: 'Entity type',
    catalogDefaultLocale: 'Default locale',
    translatorIn: 'In',
    translatorOut: 'Out',
    baseUrl: 'Base URL',
  ...
  EntityPlaceholders: {
    ...
    Id: 'Enter ID',
    SelectCatalogEntityType: 'Select entity type',
    SelectCatalogSchema: 'Select catalog schema',
    CatalogDefaultLocale: 'en',
  ...
  TestSuites: {
    ...
    EditRequestDisabledWhileTryOutOpen: 'Close Try out to edit the request',
    OpenAIChatCompletions: 'OpenAI Chat Completions',
    OpenAIResponses: 'OpenAI Responses',
    AnthropicMessages: 'Anthropic Messages',
    ...
    EndpointSchema: 'Extracted response fields',
    ...
    TemplateVariablesDescription:
      'Use ${{...}} syntax to define variables in your request template.\nVariables are replaced with values from test case data, constants, or defaults when the request is executed.',
    ...
    ColumnNotExtracted: 'Not extracted',
    ColumnNotExtractedRequestFailed: 'Request failed (HTTP {statusCode}) — no extraction was performed',
    ColumnNotExtractedStreamIncomplete: 'The response stream did not complete — no extraction was performed',
    ColumnNotExtractedNoneReported: 'No extraction was reported for this request',
    ColumnResultLabel: '{name} — {status}',
  ...
  FileManager: {
    ...
    CatalogSchemasEmptyStateTitle: "You don't have any catalog schemas",
    CatalogSchemasEmptyStateDescription: 'Create a catalog schema using the Create button',
    ...
    TranslatorsEmptyStateTitle: "You don't have any translators",
    TranslatorsEmptyStateDescription: 'Create a translator using the Create button',
  ...
  AnalyticsPipelines: {
    EnablePipeline: 'Enable pipeline',
    DisablePipeline: 'Disable pipeline',
    EnableConfirmTitle: 'Enable this pipeline?',
    DisableConfirmTitle: 'Disable this pipeline?',
    EnableConfirmDescription: 'The pipeline starts running on its trigger.',
    DisableConfirmDescription:
      'The pipeline stops running until it is enabled again. Manual scan and backfill still work.',
    EnabledChanged: 'Pipeline updated',
    ...
    Filter: 'Filter',
    FilterCaption: 'Rows the pipeline considers. Left empty, every row in the read source is considered.',
    SourceFollow: 'Follow target enrichment',
    SourceFollowCaption:
      'Following keeps the pipeline on whatever the target enrichment reads; pinning holds it to one table even if the enrichment is repointed.',
    SourceFollowUnresolved: 'Resolving the target enrichment…',
    PredicateColumnsFrom: 'Columns come from the entity of',
    ...
    SaveForbidden: 'Not entitled to a column this pipeline reads',
    SaveFailed: 'Pipeline could not be saved',
    Name: 'Name',
    Target: 'Target',
    Inputs: 'Source',
    Source: 'Source',
    ...
    PipelinesLoadFailed: 'Could not load pipelines.',
    ActionFailed: 'Action failed',
    CreatePipeline: 'Create pipeline',
    CreateRuleTitle: 'Create pipeline',
    Created: 'Pipeline created',
    Deleted: 'Pipeline deleted',
    DeletePipeline: 'Delete pipeline',
    DeleteConfirmTitle: 'Delete pipeline',
    DeleteConfirmDescription:
      'The pipeline stops running and is removed from the registry. The target table and the rows it already holds are left untouched.',
    TriggerKind: 'Trigger',
    ...
    ReadyWhenRequired:
      'Set idle or max staleness — without one, a group never becomes ready and the pipeline never runs.',
    CostCeilingInvalid: 'Enter a positive whole number.',
    MembersPlaceholderMissing:
      'This request template references no {{members}}, which a group trigger requires: the rendered prompt would reach the model carrying none of the group. Add the placeholder to the template, or choose another trigger.',
    Loading: 'Loading…',
    SectionGroupKeys: 'Group keys',
    SectionMeasures: 'Measures',
    GroupKeyColumn: 'Column',
    GroupKeyKind: 'Group by',
    GroupKeyKindColumn: 'The column itself',
    GroupKeyKindTrunc: 'A truncated period',
    GroupKeyUnit: 'Period',
    GroupKeyAlias: 'Alias',
    GroupKeyOutputName: 'Stored as {name}',
    GroupKeyNotTruncatable: 'Only a date or timestamp column can be truncated.',
    AddGroupKey: '+ Group key',
    MeasureName: 'Name',
    MeasureFn: 'Function',
    MeasureColumn: 'Column',
    MeasureWhere: 'Only over rows where',
    MeasureWhereCaption: 'Narrows this measure to some of the group. A measure that matches nothing yields null.',
    MeasureDistinct: 'Aggregate',
    MeasureDistinctNeedsColumn: 'Distinct needs a column: there is nothing to deduplicate without one.',
    MeasureUnknownFn: 'This function is no longer in the served catalog.',
    AddMeasure: '+ Measure',
    SectionRuntimeState: 'Runtime state',
    LastRun: 'Last run',
    NextRun: 'Next run',
    ...
    ClampedBy: 'Held back by {enrichment}, which has not written that far yet. This is progress, not a failure.',
    RebuildRequired: '{enrichment} was re-derived after this pipeline last built its output. A rebuild is needed.',
    UnclampedRead: '{enrichment}: {reason}',
    ...
    SourceFieldsLoadFailed:
      'Could not read what this source offers, so nothing can be bound. The columns already declared are unchanged.',
    VariablesEmpty: 'No variables declared.',
    PlaceholdersTitle: 'Template placeholders',
    PlaceholderCovered: 'covered by a variable',
    PlaceholderUncovered: 'no variable declares it',
    PlaceholderUnused: 'appears in no placeholder',
    PlaceholderAvailable: 'available',
    SectionAdvanced: 'Advanced',
    ScanEvery: 'Scan every',
    ScanEveryCaption: 'How often the runner looks for new work. Empty means the runner default.',
    RowsPerScan: 'Rows per scan',
    RowsPerCall: 'Rows per call',
    SampleFraction: 'Sample fraction',
    SampleFractionCaption: 'Share of eligible rows to evaluate, above 0 and up to 1.',
    SampleFractionInvalid: 'Enter a value above 0 and at most 1. To evaluate nothing, disable the pipeline.',
    ReadyWhenTitle: 'A group is ready when',
    ReadyWhenTitleCaption: 'Pick at least one. Whichever happens first wins.',
    ReadyWhenIdleLabel: 'it has gone quiet for',
    ReadyWhenIdleCaption: 'No new row for that long.',
    ReadyWhenSignalLabel: 'a row marks it finished',
    PredicateExample: "event_kind = 'conversation_end'",
    ReadyWhenStalenessLabel: 'its result is older than',
    ReadyWhenStalenessCaption: 'Re-evaluates the group even with no new rows.',
    CostCeilingLabel: 'Stop after',
    CostCeilingCaption: 'Evaluations of the same group. Empty means no cap.',
    DurationCustom: 'Custom',
    DurationCustomPlaceholder: '30m or PT30M',
    MemberScopeTitle: 'Which members reach the model',
    MemberScopeCaption: 'Newest first, up to what the runner asks for.',
    MemberScopeAll: 'All of them',
    MemberScopeAllCaption: 'Newest first, up to the deployment’s configured maximum.',
    MemberScopeSelected: 'A selected few',
    MemberScopeSelectedCaption: 'Cheaper, and puts the interesting rows first.',
    MemberTiebreak:
      'The source’s own order is appended last, so re-assembling an unchanged group picks the same members.',
    MemberTiebreakUnresolved: 'The source’s own order is appended last as a tiebreak.',
    SectionOutputs: 'Outputs',
    OutputsEmpty: 'The service reports no output mapping for this pipeline.',
    GroupKeysDerived: 'Leave empty to derive the keys from the target table’s ordering key.',
    MeasureColumnDefault: '= measure name',
    MeasuresColumnsNote: 'Columns come from',
    SectionTransform: 'Transform',
    TransformType: 'Type',
    TransformTypeLlm: 'LLM',
    TransformTypeSql: 'SQL',
    TransformEmpty: 'Choose a target first — its columns are what the outputs are bound to.',
    Model: 'Model',
    SectionParams: 'Model parameters',
    NoParams: 'No parameters set.',
    ParamsHint: 'Model knobs the preset passes through, such as max_tokens and temperature.',
    AddParam: '+ Parameter',
    ParamKey: 'Key',
    ParamValue: 'Value',
    SectionRequestTemplate: 'Request template',
    TemplateNotJson: 'Stored as text that is not valid JSON. It is editable as text and sent unchanged.',
    TemplatePlaceholders:
      'Placeholders the render fills in when a group-triggered pipeline runs this template. A pipeline that fires per row substitutes its own inputs instead and refuses these names.',
    TemplatePlaceholdersCaption:
      'A group-triggered pipeline needs {{members}} in this template: without it the prompt reaches the model carrying none of the group. The other four are optional.',
    PlaceholderMembers: "The group's members themselves. Required: without it the prompt carries no group data.",
    PlaceholderMembersIncluded: 'How many members the render carried.',
    PlaceholderMembersOmitted: 'How many the member-selection policy left out.',
    PlaceholderMembersTruncated: 'Whether a member was cut short to fit.',
    PlaceholderMembersNotice: 'A ready-made sentence stating what was left out, to paste beside the count.',
    OutputColumn: 'Target column',
    OutputColumnMissing: 'The target no longer carries this column.',
    OutputProse: 'What the model is told',
    OutputProseFromColumn: "Defaults to the column's description",
    OutputValues: 'Allowed values',
    OutputValuesAdd: 'Value',
    OutputValuePlaceholder: 'Value',
    OutputJsonata: 'Transform (JSONata)',
    OutputJsonataIdentity: "Leave this empty: an absent transform already means the model's field of the same name.",
    OutputRefinement: 'Refine with',
    OutputNameDuplicate: 'Two outputs share this column. The request keys outputs by column, so one would be lost.',
    OutputsOrderHint:
      'The model fills the fields in this order. Put a field after the ones it is told to derive itself from.',
    AddOutput: '+ Output',
    NoOutputs: 'No outputs declared.',
    VarExpression: 'Produced by',
    DeleteConfirmDescriptionEnrich:
      'The pipeline stops running and is removed from the registry, and its transform — the prompt, the parameters and the output declaration — is deleted with it. The target table and the rows it already holds are left untouched.',
  },
  AnalyticsTables: {
    ...
    EnumValues: 'Values',
    EnumValuesAdd: '+ Value',
    EnumValuePlaceholder: 'Value',
    EnumValuesOrderHint: 'The column sorts in this order, not alphabetically. Drag to reorder.',
    EnumValuesRequired: 'An enum column needs at least one value.',
    EnumValuesMax: 'At most {number} values.',
    EnumValueBlank: 'A value cannot be blank.',
    EnumValueDuplicate: 'Values must be unique: "{value}" is repeated.',
    EnumValuesImmutable: 'The value set cannot be changed. To change it, delete this column and add it again.',
    Nullable: 'Nullable',
    Sensitive: 'Sensitive',
  ...
  AnalyticsUsage: {
    ...
    CompareNamePreviousPeriod: 'previous period',
    CompareNamePreviousMonth: 'previous month',
    CompareNamePreviousYear: 'previous year',
    CompareOff: 'Off',
    ...
    KpiComparisonFoot: '{value} {period}',
    KpiDeltaIncrease: 'up {value} vs the compared period',
    ...
    TimeSeriesEmptyPill: 'No calls in this window',
    TimeSeriesEmptyIdle: 'The platform was idle between {from} and {to}.',
    TimeSeriesEmptyHint: 'Widen the time period to see traffic.',
    DonutEmptySubtitle: 'No calls to split in this window',
    DonutEmptyCenter: 'no calls yet',
    HeatmapEmptySubtitle: 'No activity · {timezone}',
    BreakdownFullListHeader: 'Breakdown — {dimension}',
    BreakdownEmptyTitle: 'Nothing to break down yet',
    BreakdownEmptyBody: 'No entities produced traffic in the selected period.',
    TimeSeriesTabRequests: 'Requests',
    TimeSeriesTabSplit: 'By {dimension}',
    TimeSeriesTabCost: 'Cost',
    TimeSeriesTabLatency: 'Latency',
    TimeSeriesSplitTitle: 'Usage by {dimension}',
    TimeSeriesSplitSubtitle: 'Calls per {bucket}, split across top {count}',
    TimeSeriesCostTitle: 'Spend over time',
    TimeSeriesCostSubtitle: 'Spend per {bucket}',
    TimeSeriesLatencyTitle: 'Latency',
    TimeSeriesLatencySubtitle: 'p50 and p95 response time per {bucket}',
    TimeSeriesLatencyP50: 'p50',
    TimeSeriesLatencyP95: 'p95',

    HeatmapTitle: 'Activity Heatmap',
    HeatmapSubtitle: 'Calls by hour of day · {timezone}',
    HeatmapCellLabel: '{day}, {hour}:00 — {calls} requests',
    HeatmapPreviousWeek: 'Previous week',
    HeatmapNextWeek: 'Next week',
    HeatmapDayColumn: 'Day',
    HeatmapScaleLow: 'Low',
    HeatmapScaleHigh: 'High',
    HeatmapCurrentWeek: 'This week',

    DonutTitle: 'Share breakdown',
    ...
    BreakdownTabApplications: 'Applications',
    BreakdownTabProjects: 'Projects',
    BreakdownTabMcpServers: 'MCP Servers',
    BreakdownTabTools: 'Tools',
    ColumnShareOfCalls: 'Share of calls',
    ColumnCalls: 'Calls',
    ColumnModel: 'Model',
    ...
    ColumnCost: 'Cost',
    BreakdownDescriptionModels: 'Grouped by the model that answered.',
    BreakdownDescriptionApplications:
      'Grouped by the application that called. Calls made straight to a model: Direct call.',
    BreakdownDescriptionProjects: 'Grouped by the project of the calling key. Calls with no project: No Project.',
    BreakdownDescriptionMcpServers: 'Grouped by the MCP server that answered.',
    BreakdownDescriptionTools: 'Grouped by the tool called. Calls that name no tool: Other methods.',
    ...
    PanelCalls: 'Calls',
    PanelShareOfCalls: 'Share of calls',

    NoProject: 'No Project',
    NoProjectTooltip: 'Called outside of any project',
    DirectCall: 'Direct call',
    DirectCallMcpTooltip: 'Called directly via Try out - no parent deployment',
    DirectCallRouteTooltip: 'Called directly by key or user - no parent deployment',
    ToolServerCount: '{count} MCP servers',
    ExactErrorRate: '{failed} failed of {calls} calls · {rate}',
    HeatmapMetricCalls: 'Requests',
    HeatmapMetricCost: 'Cost',
    HeatmapCellCostLabel: '{day}, {hour}:00 — {cost}',
    OtherMethods: 'Other methods',
    OtherMethodsTooltip:
      'MCP calls that name no tool - initialize, tools/list, notifications and the other protocol methods. Open View all for the full list.',
  },
  SessionsTrace: {
    Title: 'Sessions',
    Session: 'Session',
    SessionHint:
      'The session id, with the title an evaluation wrote for it above. A title is written from a size-capped copy of the session, so a long one may describe only part of it. A session the evaluation has not reached shows no title.',
    Project: 'Project',
    NoProject: 'No project',
    NoTitle: 'Untitled session',
    Turns: 'Turns',
    TurnsHint: 'Turns recorded for this session, one per request.',
    Activity: 'Activity',
    Tokens: 'Tokens',
    Cost: 'Cost',
    DurationHint:
      "The session's hop durations added up. A hop includes the hops it called, so a session whose turns branch reads longer than the time it actually took.",
    AvgDurationHint:
      "Averaged over the session's hops, not its turns, so a turn that fanned out into several hops pulls the figure toward the length of one hop rather than one turn.",
    Deployments: 'Deployments',
    DeploymentsHint:
      'Every deployment that handled a hop of this session, as recorded: models alongside routers, applications, toolsets and embeddings. Which of them is a model is not recorded, so none is filtered out.',
    Topics: 'Topics',
    TopicsHint:
      'Themes an evaluation identified in this session, not recorded by DIAL. Empty means the session has not been evaluated.',
    NoSessions: 'No sessions',
    SessionsLoadFailed: 'Could not load sessions.',
    SearchPlaceholder: 'Search sessions and projects…',
    Feedback: 'Feedback',
    FeedbackAll: 'All',
    FeedbackPositive: 'Positive feedback',
    FeedbackNegative: 'Negative feedback',
    FeedbackRated: 'Rated',
    ProvenanceSessions: 'Session',
    ProvenanceSessionsHint:
      'One row per session, refreshed periodically from the request log. Every session carries these values — without them the row would not exist.',
    ProvenanceInsights: 'Session insights',
    ProvenanceInsightsHint:
      'Computed by a separate evaluation run rather than recorded by DIAL. These values may be absent for any session, and absence means it has not been evaluated yet.',
    ProvenanceFeedback: 'Ratings',
    ProvenanceFeedbackHint:
      'Resolved by a separate query for the sessions on this page, and counted only within the selected period. Work done through a coding agent submits no ratings, so those rows are always blank here.',
    ProvenanceEnrichmentHint:
      'Computed by a separate enrichment rather than recorded by DIAL. These values may be absent for any session, and absence means the enrichment has not reached it yet.',
    ...
    SummaryPeriodHint:
      'Covers every session and coding-agent session in the selected period. The search, column filters and feedback filter narrow the list below, not this figure.',
    SchemaLoadFailed: 'Could not load the sessions schema, so the columns that depend on it were dropped.',
    FeedbackCappedNotice:
      'Showing only the most recently rated sessions. More may carry this feedback than are listed.',
    ...
    DetailLoadFailed: 'Could not load this session.',
    ...
    DetailInsightsNotEvaluated: 'This session has not been evaluated yet, so it carries no insights.',
    DetailInsightsUnavailable: 'Session insights are not available on this deployment.',
    ...
    TraceListEmptyHintLive: 'No calls are recorded against this session.',
    TraceListLoadFailedHint: 'Could not load the traces for this session.',
    TraceSectionTitle: 'Traces in this session',
    ...
    SpanCostOwn: 'Hop cost',
    SpanCostChain: 'Chain cost',
    SpanFieldsUnavailable: 'The hop log schema could not be read, so only the facts above are stated.',
    SpanJsonOpen: 'View the hop record as JSON',
    SpanTagIdentifier: 'Identity',
    SpanTagDimension: 'Record',
    SpanTagPrincipal: 'Caller',
    SpanTagDeployment: 'Deployment',
    SpanTagRequest: 'Request',
    SpanTagResponse: 'Response',
    SpanTagTokenUsage: 'Token usage',
    SpanTagCost: 'Cost',
    SpanTagPerformance: 'Performance',
    SpanTagClient: 'Client',
    SpanTagProvenance: 'Provenance',
    SpanTagTracing: 'Tracing',
    SpanTagSystem: 'System',
    SpanTagOther: 'Other',
    ...
    InspectorParamTools: 'tools offered',
    InspectorParamStream: 'stream',
    InspectorParamsLabel: 'Request parameters',
    InspectorParamsRest: '{count} more the line does not name, recorded in the body: {names}',
    ...
    InspectorRaw: 'Raw',
    InspectorResponseFactsLabel: 'What answered',
    InspectorUpstreamModel: 'model',
    InspectorPromptTokens: 'prompt',
    InspectorCompletionTokens: 'completion',
    InspectorCachedTokens: 'cached',
    InspectorNoMessages: 'This request recorded no messages.',
    InspectorFinishReason: 'finish',
    ...
    InspectorProtocolNoBody: 'The protocol defines no response body for this notification.',
    ...
    InspectorMcpFactsLabel: 'Protocol call',
    InspectorProtocolParams: 'Parameters sent',
    InspectorProtocolNoParams: 'This request carried no parameters — the method is the whole of it.',
    InspectorProtocolResult: 'Result',
    InspectorTransportLabel: 'How the call went',
    InspectorTransportStatus: 'Status',
    InspectorTransportMethod: 'Method',
    InspectorTransportSent: 'sent',
    InspectorTransportReceived: 'received',
    InspectorTransportTook: 'took',
    InspectorToolAnswers: 'answers',
    InspectorToolFailed: 'failed',
    InspectorChat: 'Chat',
    InspectorChatLabel: 'Session as this span received it',
    InspectorChatNoMessages: 'This span received no session.',
  ...
  SystemProperties: {
    RateLimitScheduleDescription:
      'Anchors the day/week/month rate-limit windows configured per role. The windows reset at the given time, in the given timezone, counting weeks from the chosen start day.',
    ...
    ResetTimePlaceholder: 'HH:mm',
    ResetTimeInvalid: 'Use the 24-hour HH:mm format, e.g. 09:30',
  },
} as const;
