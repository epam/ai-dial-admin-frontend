...
export const onOpenInNewTab = (route?: ApplicationRoute, entity?: BaseEntity, entityType?: DEPLOYMENT_ENTITY) => {
  const url = getUrnForEntity(route, entity, entityType);
  window.open(url, '_blank');
};

export const getUrnForEntity = (route?: ApplicationRoute, entity?: BaseEntity, entityType?: DEPLOYMENT_ENTITY) => {
