...
describe('DurationField', () => {
  ...
  test('renders an amount input paired with a unit select', () => {
    ...
    expect(screen.getByText(AnalyticsEnrichmentRulesI18nKey.UnitMinutes)).toBeTruthy();
  });
  ...
  test('shows the amount and unit of a short-form value', () => {
    ...
    expect(screen.getByText(AnalyticsEnrichmentRulesI18nKey.UnitHours)).toBeTruthy();
  });
  ...
  test('emits the short form when the unit is changed', async () => {
    ...
    await user.click(screen.getByText(AnalyticsEnrichmentRulesI18nKey.UnitMinutes));
    await user.click(screen.getByText(AnalyticsEnrichmentRulesI18nKey.UnitHours));
