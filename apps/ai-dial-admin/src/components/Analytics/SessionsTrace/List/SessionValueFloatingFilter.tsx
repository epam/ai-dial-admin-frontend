 ...
 */
const SessionValueFloatingFilter = forwardRef<unknown, IFloatingFilterParams>((_props, ref) => {
...
SessionValueFloatingFilter.displayName = 'SessionValueFloatingFilter';

export default SessionValueFloatingFilter;
