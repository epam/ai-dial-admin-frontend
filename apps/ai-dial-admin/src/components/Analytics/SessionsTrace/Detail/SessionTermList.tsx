...
import { SessionTerm } from '@/src/models/analytics/sessions-trace';
...
// catalog identifier naming an entity the page queried, which a session id or a user hash is not.
//
...
const SessionTermList: FC<Props> = ({ terms }) => (
...
export default SessionTermList;
