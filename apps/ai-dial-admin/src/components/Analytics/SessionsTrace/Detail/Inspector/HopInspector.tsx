...
import HopEmbeddingPanel from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopEmbeddingPanel';
import HopEmbeddingResultPanel from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopEmbeddingResultPanel';
import HopMcpArgumentsPanel from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopMcpArgumentsPanel';
import HopMcpFactsLine from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopMcpFactsLine';
import HopMcpResultPanel from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopMcpResultPanel';
import HopParamsLine from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopParamsLine';
import HopProtocolRequestPanel from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopProtocolRequestPanel';
import HopProtocolResultPanel from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopProtocolResultPanel';
import HopRawSwitch from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopRawSwitch';
import HopRawView from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopRawView';
import HopRequestPanel from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopRequestPanel';
import HopTransportLine from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopTransportLine';
import HopResponseFactsLine from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopResponseFactsLine';
import HopResponsePanel from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopResponsePanel';
import HopStateNote from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/HopStateNote';
import {
  useHopEmbeddingFacts,
  useHopMcpFacts,
  useHopProtocolFacts,
} from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/use-hop-facts';
import {
  useHopRequest,
  useHopResponse,
} from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/use-hop-envelope';
import { useSpanBodyTabs } from '@/src/components/Analytics/SessionsTrace/Detail/Inspector/use-span-body-tabs';
...
import { hopSideSuppressionsOf, hopTransportOf, isProtocolEnvelope } from '@/src/utils/analytics/session-spans';
...
const TAB_LABEL_KEY: Record<SpanBodyTab, string> = {
  [SpanBodyTab.Request]: SessionsTraceI18nKey.InspectorRequest,
  [SpanBodyTab.Response]: SessionsTraceI18nKey.InspectorResponse,
  [SpanBodyTab.Chat]: SessionsTraceI18nKey.InspectorChat,
};
  ...
  return (
    ...
    <div className="flex min-h-0 min-w-0 flex-1 flex-col bg-layer-1">
      ...
      <div className="flex min-w-0 shrink-0 flex-col gap-2 bg-layer-1 pb-3">
        <Tabs
          ariaLabel={t(SessionsTraceI18nKey.InspectorTabsLabel)}
          tabs={tabItems}
