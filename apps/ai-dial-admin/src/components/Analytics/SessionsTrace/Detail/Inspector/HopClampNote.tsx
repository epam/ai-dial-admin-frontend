...
import { HopClamp } from '@/src/models/analytics/sessions-trace';
import { formatBytes } from '@/src/utils/analytics/session-formatting';
...
const HopClampNote: FC<Props> = ({ clamp }) => {
  ...
  return (
    <p role="status" aria-live="polite" className="text-secondary dial-caption-text">
      {t(SessionsTraceI18nKey.InspectorRawClamped, {
