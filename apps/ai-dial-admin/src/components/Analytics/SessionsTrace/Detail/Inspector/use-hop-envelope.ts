...
import { getSessionHopRequest, getSessionHopResponse } from '@/src/app/[lang]/sessions/actions';
...
export const useHopRequest = (params: Params) =>
  useHeldRead<HopRequestEnvelope>(params, 'request', getSessionHopRequest, FAILED_REQUEST);

export const useHopResponse = (params: Params) =>
  useHeldRead<HopResponseEnvelope>(params, 'response', getSessionHopResponse, FAILED_RESPONSE);
