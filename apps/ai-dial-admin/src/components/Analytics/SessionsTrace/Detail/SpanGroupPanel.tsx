...
import SpanObjectFactRow from '@/src/components/Analytics/SessionsTrace/Detail/SpanObjectFactRow';
import { SPAN_FIELD_TAG_LABEL_KEY, UNAVAILABLE_VALUE } from '@/src/constants/analytics/sessions-trace';
import { useI18n } from '@/src/locales/client';
import { SpanFieldDescriptor, SpanFieldGroup, SpanFieldRow } from '@/src/models/analytics/sessions-trace';
...
import {
  ...
  spanGroupSummary,
  spanObjectEntries,
} from '@/src/utils/analytics/session-span-fields';
