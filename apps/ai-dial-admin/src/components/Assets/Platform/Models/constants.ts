...
import { ModelResourceSwitchFeatureGroup } from './models';

export const modelResourceTextFeatures: (keyof DialModelResourceFeatures)[] = [
  'rate_endpoint',
  'tokenize_endpoint',
...
export const modelResourceSwitchGroups: ModelResourceSwitchFeatureGroup[] = [
  {
  ...
  },
  {
    ...
    keys: ['cache_supported', 'auto_caching_supported'],
  },
  {
    title: FeaturesI18nKey.GroupSessionAccess,
    keys: ['allow_resume', 'accessible_by_per_request_key'],
  },
  {
...
export const modelResourceFeatureLabelMap: Record<keyof DialModelResourceFeatures, FeaturesI18nKey> = {
  ...
  cache_supported: FeaturesI18nKey.cacheSupported,
  auto_caching_supported: FeaturesI18nKey.autoCachingSupported,
...
export const modelResourceFeaturePlaceholderMap: Record<string, EntityPlaceholdersI18nKey> = {
