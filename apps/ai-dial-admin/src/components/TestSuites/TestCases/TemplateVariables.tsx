...
const TemplateVariables: FC<Props> = ({ selectedTestSuite, testCaseSchema, onChange, isSkipRefresh }) => {
  const t = useI18n();
  ...
  }, [onChangeParam, onChangeSelect, selectedTestSuite.id, testCaseSchema, t]);
