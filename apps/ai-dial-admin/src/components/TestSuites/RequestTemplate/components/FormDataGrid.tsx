...
export interface FormDataGridRef {
  add: () => void;
}
...
const FormDataGrid = forwardRef<FormDataGridRef, Props>(
  ({ content, changeContent, hideAddButton, selectedTestSuiteId }, ref) => {
    const t = useI18n();
    ...
    useImperativeHandle(ref, () => ({ add: onAddPart }), [onAddPart]);
...
FormDataGrid.displayName = 'FormDataGrid';
