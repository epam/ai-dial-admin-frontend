...
const RulesItemBody: FC<Props> = ({
  ...
  const ruleClassName = classNames('relative flex flex-row');
  const lineVerticalClassName = classNames('w-[1px] ml-1 bg-accent-primary');
    ...
    <>
      ...
      <div className={ruleClassName}>
        <div
          ...
          className={lineVerticalClassName}
        ></div>
        <RulesValueList
          rules={rules}
