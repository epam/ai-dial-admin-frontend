...
export const listViewTitleMap: Record<string, MenuI18nKey> = {
  ...
  [ApplicationRoute.AssetsInterceptors]: MenuI18nKey.AssetsInterceptors,
  [ApplicationRoute.AssetsRoutes]: MenuI18nKey.AssetsRoutes,
  [ApplicationRoute.AssetsRoles]: MenuI18nKey.AssetsRoles,
  ...
  [ApplicationRoute.SkillPublications]: MenuI18nKey.SkillPublications,
  ...
  [ApplicationRoute.AnalyticsQueries]: MenuI18nKey.Queries,
...
export const emptyDataTitleMap: Record<string, EntitiesI18nKey> = {
  ...
  [ApplicationRoute.AssetsModels]: EntitiesI18nKey.NoModels,
  ...
  [ApplicationRoute.SkillPublications]: EntitiesI18nKey.NoPublications,
  ...
  [ApplicationRoute.AnalyticsQueries]: EntitiesI18nKey.NoQueries,
