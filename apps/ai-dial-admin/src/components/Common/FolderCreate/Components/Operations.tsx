...
export const getAddSiblingOperation = <T extends object>(
  onClick: () => void,
  t: (key: string) => string,
...
export const getAddChildOperation = <T extends object>(
  onClick: () => void,
  t: (key: string) => string,
): ActionMenuOperationDeclaration<T> => {
  return {
...
export const getManageFolderOperation = <T extends object>(
  onClick: () => void,
  t: (key: string) => string,
): ActionMenuOperationDeclaration<T> => {
  return {
...
export const getRenameFolderOperation = <T extends object>(
  onClick: () => void,
  t: (key: string) => string,
): ActionMenuOperationDeclaration<T> => {
  return {
...
export const getMoveFolderOperation = <T extends object>(
  onClick: () => void,
  t: (key: string) => string,
): ActionMenuOperationDeclaration<T> => {
  return {
...
export const getDeleteFolderOperation = <T extends object>(
  onClick: () => void,
  t: (key: string) => string,
): ActionMenuOperationDeclaration<T> => {
  return {
