...
import { ActivityAuditI18nKey, PublicationsI18nKey } from '@/src/constants/i18n';
  ...
  return (
    <div className="flex flex-row w-full justify-between flex-wrap lg:flex-nowrap">
      <div className="flex flex-row gap-10 w-full flex-wrap">
        {activity.action && <LabeledText label={t(PublicationsI18nKey.Action)} text={activity.action} />}
