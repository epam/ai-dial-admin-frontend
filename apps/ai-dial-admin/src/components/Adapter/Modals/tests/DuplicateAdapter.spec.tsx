...
describe('DuplicateAdapter', () => {
  ...
  test('renders all fields and buttons', () => {
    render(
      <DuplicateAdapter isModalOpen={true} names={[]} onClose={vi.fn()} adapter={baseAdapter} onDuplicate={vi.fn()} />,
    );
  ...
  test('calls onClose when Cancel is clicked', () => {
    const onClose = vi.fn();
    render(
      <DuplicateAdapter isModalOpen={true} names={[]} onClose={onClose} adapter={baseAdapter} onDuplicate={vi.fn()} />,
    );
