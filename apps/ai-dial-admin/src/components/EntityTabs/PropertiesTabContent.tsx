...
const PropertiesTabContent = <T extends object>({ children, headerPostfix, headerPrefix, ...props }: Props<T>) => {
  return (
    <div className="flex flex-col">
      <EntityInfoHeader {...props} postfix={headerPostfix} prefix={headerPrefix} />
