...
export enum DeploymentsI18nKey {
  ...
  NodePoolColumnAccelerator = 'Deployments.NodePoolColumnAccelerator',
  NodePoolColumnCpu = 'Deployments.NodePoolColumnCpu',
  NodePoolColumnMemory = 'Deployments.NodePoolColumnMemory',
  NodePoolColumnNodes = 'Deployments.NodePoolColumnNodes',
  NodePoolCpuOnly = 'Deployments.NodePoolCpuOnly',
  NodePoolEmpty = 'Deployments.NodePoolEmpty',
  NodePoolLoadError = 'Deployments.NodePoolLoadError',
  NodePoolUnitVram = 'Deployments.NodePoolUnitVram',
  NodePoolUnitRam = 'Deployments.NodePoolUnitRam',
  NodePoolUnitNodes = 'Deployments.NodePoolUnitNodes',
  NodePoolModalTitle = 'Deployments.NodePoolModalTitle',
  NodePoolSelect = 'Deployments.NodePoolSelect',
  NodePoolNotSelected = 'Deployments.NodePoolNotSelected',
