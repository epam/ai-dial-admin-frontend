...
export enum MenuI18nKey {
  ...
  PlatformAppRunners = 'Menu.PlatformAppRunners',
  PlatformCatalogSchemas = 'Menu.PlatformCatalogSchemas',
...
export enum EntitiesI18nKey {
  ...
  SkillFileUploadSuccess = 'Entities.SkillFileUploadSuccess',
  SkillFileUploadError = 'Entities.SkillFileUploadError',
  SkillFileRemoveSuccess = 'Entities.SkillFileRemoveSuccess',
  SkillFileRemoveError = 'Entities.SkillFileRemoveError',
...
export enum DeleteI18nKey {
  ...
  CatalogSchema = 'DeleteEntity.Entities.CatalogSchema',
  ...
  CatalogSchemas = 'DeleteEntity.BulkDelete.CatalogSchemas',
...
export enum ButtonsI18nKey {
  ...
  SaveAsNewImage = 'Buttons.SaveAsNewImage',
  Apply = 'Buttons.Apply',
  ...
  Back = 'Buttons.Back',
  GoToHomepage = 'Buttons.GoToHomepage',
...
export enum UpdateI18nKey {
  ...
  CatalogSchema = 'UpdateEntity.Entities.CatalogSchema',
...
export enum CreateI18nKey {
  ...
  CatalogSchema = 'CreateEntity.Entities.CatalogSchema',
...
export enum RolesI18nKey {
  ...
  NotAvailableRoute = 'Roles.NotAvailableRoute',
...
export enum TelemetryI18nKey {
  ...
  NoRoutes = 'Telemetry.UsageLog.NoRoutes',
  ...
  CallsByRoute = 'Telemetry.CallsByRoute',
  CallsByProject = 'Telemetry.CallsByProject',
  CallsFromParentDeployments = 'Telemetry.CallsFromParentDeployments',
  NoProject = 'Telemetry.NoProject',
  NoProjectTooltip = 'Telemetry.NoProjectTooltip',
  DirectCall = 'Telemetry.DirectCall',
  DirectCallTooltip = 'Telemetry.DirectCallTooltip',
  DirectCallByKeyOrUserTooltip = 'Telemetry.DirectCallByKeyOrUserTooltip',
...
export enum ErrorI18nKey {
  ...
  ReturnToHomepage = 'Error.ReturnToHomepage',
...
export enum EntityPlaceholdersI18nKey {
  ...
  Intro = 'EntityPlaceholders.Intro',
  VendorWebsite = 'EntityPlaceholders.VendorWebsite',
  DisplayName = 'EntityPlaceholders.DisplayName',
  Id = 'EntityPlaceholders.Id',
  SelectCatalogEntityType = 'EntityPlaceholders.SelectCatalogEntityType',
  SelectCatalogSchema = 'EntityPlaceholders.SelectCatalogSchema',
  CatalogDefaultLocale = 'EntityPlaceholders.CatalogDefaultLocale',
  ...
  CompletionEndpointPath = 'EntityPlaceholders.CompletionEndpointPath',
  ResponsesEndpointPath = 'EntityPlaceholders.ResponsesEndpointPath',
...
export enum EntityFieldsI18nKey {
  ...
  catalogEntityType = 'EntityFields.catalogEntityType',
  catalogDefaultLocale = 'EntityFields.catalogDefaultLocale',
  ...
  intro = 'EntityFields.intro',
  vendorWebsite = 'EntityFields.vendorWebsite',
  ...
  'dial:applicationTypeSchemaEndpoint' = 'EntityFields.applicationTypeSchemaEndpoint',
  ...
  completionEndpointPath = 'EntityFields.completionEndpointPath',
  responsesEndpointPath = 'EntityFields.responsesEndpointPath',
...
export enum ImagesI18nKey {
  ...
  SaveNewImageModalTitle = 'Images.SaveNewImageModalTitle',
...
export enum ContainersI18nKey {
  ...
  ServerDetails = 'Containers.ServerDetails',
  LastUpdate = 'Containers.LastUpdate',
  Repository = 'Containers.Repository',
  Remotes = 'Containers.Remotes',
  ViewFullServerJson = 'Containers.ViewFullServerJson',
  NoServerDetails = 'Containers.NoServerDetails',
...
export enum TestSuitesI18nKey {
  ...
  EditRequest = 'TestSuites.EditRequest',
  RenameRequest = 'TestSuites.RenameRequest',
  EditRequestDisabledWhileTryOutOpen = 'TestSuites.EditRequestDisabledWhileTryOutOpen',
  ...
  OverallScoreWeightPositive = 'TestSuites.OverallScoreWeightPositive',
  OverallScoreAtLeastOneMetric = 'TestSuites.OverallScoreAtLeastOneMetric',
  OverallScoreMetricDeleted = 'TestSuites.OverallScoreMetricDeleted',
...
export enum RunsI18nKey {
  ...
  MetricScoresDescriptionAvg = 'Runs.MetricScoresDescriptionAvg',
  MetricScoresDescriptionP90 = 'Runs.MetricScoresDescriptionP90',
  MetricScoresDescriptionP10 = 'Runs.MetricScoresDescriptionP10',
  MetricScoresDescriptionMax = 'Runs.MetricScoresDescriptionMax',
  MetricScoresDescriptionMin = 'Runs.MetricScoresDescriptionMin',
  MetricScoresDescriptionMed = 'Runs.MetricScoresDescriptionMed',
  MetricScoresDescriptionCount = 'Runs.MetricScoresDescriptionCount',
  ...
  TestCaseColumn = 'Runs.TestCaseColumn',
...
export enum FileManagerI18nKey {
  ...
  CatalogSchemas = 'FileManager.CatalogSchemas',
  CatalogSchema = 'FileManager.CatalogSchema',
  ...
  CatalogSchemasEmptyStateTitle = 'FileManager.CatalogSchemasEmptyStateTitle',
  CatalogSchemasEmptyStateDescription = 'FileManager.CatalogSchemasEmptyStateDescription',
  ...
  SkillsEmptyStateDescription = 'FileManager.SkillsEmptyStateDescription',
  ...
  ImportErrorTitle = 'FileManager.Notifications.Import.ErrorTitle',
  ImportErrorDescription = 'FileManager.Notifications.Import.ErrorDescription',
  ImportSkippedTitle = 'FileManager.Notifications.Import.SkippedTitle',
  ImportSkippedDescription = 'FileManager.Notifications.Import.SkippedDescription',
...
export enum QueryBuilderI18nKey {
  ...
  AddSortKey = 'QueryBuilder.AddSortKey',
  Page = 'QueryBuilder.Page',
  IncludePage = 'QueryBuilder.IncludePage',
  Strategy = 'QueryBuilder.Strategy',
  Offset = 'QueryBuilder.Offset',
  Limit = 'QueryBuilder.Limit',
  IncludeTotal = 'QueryBuilder.IncludeTotal',
  ...
  ValuePlaceholder = 'QueryBuilder.ValuePlaceholder',
  InValuePlaceholder = 'QueryBuilder.InValuePlaceholder',
  AliasPlaceholder = 'QueryBuilder.AliasPlaceholder',
  ...
  DiscardQueryHeader = 'QueryBuilder.DiscardQueryHeader',
  DiscardQueryDescriptionBuilder = 'QueryBuilder.DiscardQueryDescriptionBuilder',
  DiscardQueryDescriptionJson = 'QueryBuilder.DiscardQueryDescriptionJson',
  NotShownInBuilder = 'QueryBuilder.NotShownInBuilder',
  ...
  ChartNoRows = 'QueryBuilder.ChartNoRows',
  ChartNoDimension = 'QueryBuilder.ChartNoDimension',
  ChartNoValueColumn = 'QueryBuilder.ChartNoValueColumn',
  ChartNoAxisSelection = 'QueryBuilder.ChartNoAxisSelection',
  ...
  AiSend = 'QueryBuilder.AiSend',
  AiSending = 'QueryBuilder.AiSending',
...
export enum AnalyticsTablesI18nKey {
  CreateSource = 'AnalyticsTables.CreateSource',
  CreateEnrichment = 'AnalyticsTables.CreateEnrichment',
  Name = 'AnalyticsTables.Name',
  Description = 'AnalyticsTables.Description',
  Type = 'AnalyticsTables.Type',
  TypeSource = 'AnalyticsTables.TypeSource',
  TypeEnrichment = 'AnalyticsTables.TypeEnrichment',
  ...
  CreateEnrichmentTitle = 'AnalyticsTables.CreateEnrichmentTitle',
  WriteMode = 'AnalyticsTables.WriteMode',
  WriteModeHint = 'AnalyticsTables.WriteModeHint',
  WriteModeAppend = 'AnalyticsTables.WriteModeAppend',
  WriteModeAppendDescription = 'AnalyticsTables.WriteModeAppendDescription',
  WriteModeUpsertByKey = 'AnalyticsTables.WriteModeUpsertByKey',
  WriteModeUpsertByKeyDescription = 'AnalyticsTables.WriteModeUpsertByKeyDescription',
  Columns = 'AnalyticsTables.Columns',
  AddColumn = 'AnalyticsTables.AddColumn',
  Keys = 'AnalyticsTables.Keys',
  KeysNote = 'AnalyticsTables.KeysNote',
  OrderingKey = 'AnalyticsTables.OrderingKey',
  OrderingKeyHint = 'AnalyticsTables.OrderingKeyHint',
  PartitionColumn = 'AnalyticsTables.PartitionColumn',
  PartitionColumnHint = 'AnalyticsTables.PartitionColumnHint',
  Granularity = 'AnalyticsTables.Granularity',
  GranularityHint = 'AnalyticsTables.GranularityHint',
  PartitionNone = 'AnalyticsTables.PartitionNone',
  IdentityColumn = 'AnalyticsTables.IdentityColumn',
  VersionColumn = 'AnalyticsTables.VersionColumn',
  IdentityColumnHint = 'AnalyticsTables.IdentityColumnHint',
  VersionColumnHint = 'AnalyticsTables.VersionColumnHint',
  ...
  ElementType = 'AnalyticsTables.ElementType',
  EnumValues = 'AnalyticsTables.EnumValues',
  EnumValuesAdd = 'AnalyticsTables.EnumValuesAdd',
  EnumValuePlaceholder = 'AnalyticsTables.EnumValuePlaceholder',
  EnumValuesOrderHint = 'AnalyticsTables.EnumValuesOrderHint',
  EnumValuesRequired = 'AnalyticsTables.EnumValuesRequired',
  EnumValuesMax = 'AnalyticsTables.EnumValuesMax',
  EnumValueBlank = 'AnalyticsTables.EnumValueBlank',
  EnumValueDuplicate = 'AnalyticsTables.EnumValueDuplicate',
  EnumValuesImmutable = 'AnalyticsTables.EnumValuesImmutable',
  Nullable = 'AnalyticsTables.Nullable',
  Sensitive = 'AnalyticsTables.Sensitive',
  AddColumns = 'AnalyticsTables.AddColumns',
  AddRows = 'AnalyticsTables.AddRows',
  InsertRows = 'AnalyticsTables.InsertRows',
  DisplayName = 'AnalyticsTables.DisplayName',
  DeleteTable = 'AnalyticsTables.DeleteTable',
  DeleteConfirmTitle = 'AnalyticsTables.DeleteConfirmTitle',
  DeleteConfirmDescription = 'AnalyticsTables.DeleteConfirmDescription',
  EditColumnTitle = 'AnalyticsTables.EditColumnTitle',
  NoColumns = 'AnalyticsTables.NoColumns',
  Created = 'AnalyticsTables.Created',
  Deleted = 'AnalyticsTables.Deleted',
  SchemaUpdated = 'AnalyticsTables.SchemaUpdated',
  ...
  Status = 'AnalyticsTables.Status',
  StatusPending = 'AnalyticsTables.StatusPending',
  StatusActive = 'AnalyticsTables.StatusActive',
  StatusFailed = 'AnalyticsTables.StatusFailed',
  DraftSchema = 'AnalyticsTables.DraftSchema',
  TableActive = 'AnalyticsTables.TableActive',
  ActivationFailedHint = 'AnalyticsTables.ActivationFailedHint',
  EditTableTitle = 'AnalyticsTables.EditTableTitle',
  TableUpdated = 'AnalyticsTables.TableUpdated',
  TagOrder = 'AnalyticsTables.TagOrder',
  TagOrderEmpty = 'AnalyticsTables.TagOrderEmpty',
  ...
  Connect = 'AnalyticsTables.Connect',
  ...
  ConnectFlightUriHint = 'AnalyticsTables.ConnectFlightUriHint',
  ConnectWhoCanWrite = 'AnalyticsTables.ConnectWhoCanWrite',
  ConnectWriteRolesHint = 'AnalyticsTables.ConnectWriteRolesHint',
  ConnectRolesLoading = 'AnalyticsTables.ConnectRolesLoading',
  ConnectNoWriteRoles = 'AnalyticsTables.ConnectNoWriteRoles',
  ConnectAdminWrites = 'AnalyticsTables.ConnectAdminWrites',
  ConnectWhoCanRead = 'AnalyticsTables.ConnectWhoCanRead',
  ConnectReadScope = 'AnalyticsTables.ConnectReadScope',
  ConnectRowLimits = 'AnalyticsTables.ConnectRowLimits',
  ConnectRestLimits = 'AnalyticsTables.ConnectRestLimits',
  ConnectFlightLimits = 'AnalyticsTables.ConnectFlightLimits',
  ConnectFormats = 'AnalyticsTables.ConnectFormats',
  ConnectFormatTimestamp = 'AnalyticsTables.ConnectFormatTimestamp',
  ConnectFormatDate = 'AnalyticsTables.ConnectFormatDate',
  ConnectFormatDecimal = 'AnalyticsTables.ConnectFormatDecimal',
  ConnectFormatArray = 'AnalyticsTables.ConnectFormatArray',
  ConnectBatchLimit = 'AnalyticsTables.ConnectBatchLimit',
  ConnectRejected = 'AnalyticsTables.ConnectRejected',
  ConnectUnknownColumn = 'AnalyticsTables.ConnectUnknownColumn',
  ConnectNotAuthorized = 'AnalyticsTables.ConnectNotAuthorized',
  ConnectPython = 'AnalyticsTables.ConnectPython',
  ConnectPythonHint = 'AnalyticsTables.ConnectPythonHint',
  ConnectCurl = 'AnalyticsTables.ConnectCurl',
...
export enum AnalyticsPipelinesI18nKey {
  Name = 'AnalyticsPipelines.Name',
  Source = 'AnalyticsPipelines.Source',
  Trigger = 'AnalyticsPipelines.Trigger',
  Evaluator = 'AnalyticsPipelines.Evaluator',
  ...
  UpdatedAt = 'AnalyticsPipelines.UpdatedAt',
  Latest = 'AnalyticsPipelines.Latest',
  StatusEnabled = 'AnalyticsPipelines.StatusEnabled',
  StatusDisabled = 'AnalyticsPipelines.StatusDisabled',
  GroupedBy = 'AnalyticsPipelines.GroupedBy',
  ActionFailed = 'AnalyticsPipelines.ActionFailed',
  CreateRuleTitle = 'AnalyticsPipelines.CreateRuleTitle',
  Created = 'AnalyticsPipelines.Created',
  Deleted = 'AnalyticsPipelines.Deleted',
  DeleteConfirmTitle = 'AnalyticsPipelines.DeleteConfirmTitle',
  DeleteConfirmDescription = 'AnalyticsPipelines.DeleteConfirmDescription',
  NoEvaluatorsNote = 'AnalyticsPipelines.NoEvaluatorsNote',
  EvaluatorVersion = 'AnalyticsPipelines.EvaluatorVersion',
  VersionLatest = 'AnalyticsPipelines.VersionLatest',
  TriggerKind = 'AnalyticsPipelines.TriggerKind',
  TriggerOnIngest = 'AnalyticsPipelines.TriggerOnIngest',
  TriggerSchedule = 'AnalyticsPipelines.TriggerSchedule',
  TriggerGroup = 'AnalyticsPipelines.TriggerGroup',
  EnabledYes = 'AnalyticsPipelines.EnabledYes',
  EnabledNo = 'AnalyticsPipelines.EnabledNo',
  GroupBy = 'AnalyticsPipelines.GroupBy',
  GroupByCaption = 'AnalyticsPipelines.GroupByCaption',
  CronPreset = 'AnalyticsPipelines.CronPreset',
  CronExpression = 'AnalyticsPipelines.CronExpression',
  CronInvalid = 'AnalyticsPipelines.CronInvalid',
  CronEveryFiveMinutes = 'AnalyticsPipelines.CronEveryFiveMinutes',
  CronHourly = 'AnalyticsPipelines.CronHourly',
  CronDailyMidnight = 'AnalyticsPipelines.CronDailyMidnight',
  CronCustom = 'AnalyticsPipelines.CronCustom',
  ReadyWhenIdle = 'AnalyticsPipelines.ReadyWhenIdle',
  ReadyWhenMaxStaleness = 'AnalyticsPipelines.ReadyWhenMaxStaleness',
  ReadyWhenCostCeiling = 'AnalyticsPipelines.ReadyWhenCostCeiling',
  ReadyWhenRequired = 'AnalyticsPipelines.ReadyWhenRequired',
  CostCeilingInvalid = 'AnalyticsPipelines.CostCeilingInvalid',
  EvaluatorLoadFailed = 'AnalyticsPipelines.EvaluatorLoadFailed',
  MembersPlaceholderMissing = 'AnalyticsPipelines.MembersPlaceholderMissing',
  EvaluatorsLoadFailed = 'AnalyticsPipelines.EvaluatorsLoadFailed',
  ReadOnlyFacts = 'AnalyticsPipelines.ReadOnlyFacts',
  CreatedAt = 'AnalyticsPipelines.CreatedAt',
  Updated = 'AnalyticsPipelines.Updated',
  EvaluatorResolved = 'AnalyticsPipelines.EvaluatorResolved',
  EvaluatorType = 'AnalyticsPipelines.EvaluatorType',
  NotSet = 'AnalyticsPipelines.NotSet',
  Saved = 'AnalyticsPipelines.Saved',
  SaveFailed = 'AnalyticsPipelines.SaveFailed',
  SaveForbidden = 'AnalyticsPipelines.SaveForbidden',
  SectionReadScope = 'AnalyticsPipelines.SectionReadScope',
  SourceFollow = 'AnalyticsPipelines.SourceFollow',
  SourceFollowCaption = 'AnalyticsPipelines.SourceFollowCaption',
  SourceFollowUnresolved = 'AnalyticsPipelines.SourceFollowUnresolved',
  SourcePin = 'AnalyticsPipelines.SourcePin',
  SourcePinCaption = 'AnalyticsPipelines.SourcePinCaption',
  SourceTable = 'AnalyticsPipelines.SourceTable',
  PredicateColumnsFrom = 'AnalyticsPipelines.PredicateColumnsFrom',
  PredicateSourceUnresolved = 'AnalyticsPipelines.PredicateSourceUnresolved',
  SectionMemberSelect = 'AnalyticsPipelines.SectionMemberSelect',
  PreferSql = 'AnalyticsPipelines.PreferSql',
  PreferSqlCaption = 'AnalyticsPipelines.PreferSqlCaption',
  OrderBy = 'AnalyticsPipelines.OrderBy',
  OrderByColumn = 'AnalyticsPipelines.OrderByColumn',
  OrderByDirection = 'AnalyticsPipelines.OrderByDirection',
  AddOrderBy = 'AnalyticsPipelines.AddOrderBy',
  SortAscending = 'AnalyticsPipelines.SortAscending',
  SortDescending = 'AnalyticsPipelines.SortDescending',
  MemberLimit = 'AnalyticsPipelines.MemberLimit',
  MemberLimitCaption = 'AnalyticsPipelines.MemberLimitCaption',
  MemberLimitRequired = 'AnalyticsPipelines.MemberLimitRequired',
  ReadyWhenSignal = 'AnalyticsPipelines.ReadyWhenSignal',
  ReadyWhenSignalCaption = 'AnalyticsPipelines.ReadyWhenSignalCaption',
  RateRpm = 'AnalyticsPipelines.RateRpm',
  EnableConfirmTitle = 'AnalyticsPipelines.EnableConfirmTitle',
  DisableConfirmTitle = 'AnalyticsPipelines.DisableConfirmTitle',
  EnableConfirmDescription = 'AnalyticsPipelines.EnableConfirmDescription',
  DisableConfirmDescription = 'AnalyticsPipelines.DisableConfirmDescription',
  EnabledChanged = 'AnalyticsPipelines.EnabledChanged',
  ToggleBlockedByEdits = 'AnalyticsPipelines.ToggleBlockedByEdits',
  AddGroupKey = 'AnalyticsPipelines.AddGroupKey',
  AddMeasure = 'AnalyticsPipelines.AddMeasure',
  Backlog = 'AnalyticsPipelines.Backlog',
  BacklogNo = 'AnalyticsPipelines.BacklogNo',
  BacklogYes = 'AnalyticsPipelines.BacklogYes',
  ClampedBy = 'AnalyticsPipelines.ClampedBy',
  CreatePipeline = 'AnalyticsPipelines.CreatePipeline',
  DeletePipeline = 'AnalyticsPipelines.DeletePipeline',
  DisablePipeline = 'AnalyticsPipelines.DisablePipeline',
  DrainedAt = 'AnalyticsPipelines.DrainedAt',
  EnablePipeline = 'AnalyticsPipelines.EnablePipeline',
  Filter = 'AnalyticsPipelines.Filter',
  FilterCaption = 'AnalyticsPipelines.FilterCaption',
  GroupKeyAlias = 'AnalyticsPipelines.GroupKeyAlias',
  GroupKeyColumn = 'AnalyticsPipelines.GroupKeyColumn',
  GroupKeyKind = 'AnalyticsPipelines.GroupKeyKind',
  GroupKeyKindColumn = 'AnalyticsPipelines.GroupKeyKindColumn',
  GroupKeyKindTrunc = 'AnalyticsPipelines.GroupKeyKindTrunc',
  GroupKeyNotTruncatable = 'AnalyticsPipelines.GroupKeyNotTruncatable',
  GroupKeyOutputName = 'AnalyticsPipelines.GroupKeyOutputName',
  GroupKeyUnit = 'AnalyticsPipelines.GroupKeyUnit',
  Inputs = 'AnalyticsPipelines.Inputs',
  Kind = 'AnalyticsPipelines.Kind',
  KindAggregate = 'AnalyticsPipelines.KindAggregate',
  KindEnrich = 'AnalyticsPipelines.KindEnrich',
  Lag = 'AnalyticsPipelines.Lag',
  LagSeconds = 'AnalyticsPipelines.LagSeconds',
  LastRun = 'AnalyticsPipelines.LastRun',
  MeasureColumn = 'AnalyticsPipelines.MeasureColumn',
  MeasureDistinct = 'AnalyticsPipelines.MeasureDistinct',
  MeasureDistinctNeedsColumn = 'AnalyticsPipelines.MeasureDistinctNeedsColumn',
  MeasureFn = 'AnalyticsPipelines.MeasureFn',
  MeasureName = 'AnalyticsPipelines.MeasureName',
  MeasureUnknownFn = 'AnalyticsPipelines.MeasureUnknownFn',
  MeasureWhere = 'AnalyticsPipelines.MeasureWhere',
  MeasureWhereCaption = 'AnalyticsPipelines.MeasureWhereCaption',
  NextRun = 'AnalyticsPipelines.NextRun',
  NoPipelines = 'AnalyticsPipelines.NoPipelines',
  PipelinesLoadFailed = 'AnalyticsPipelines.PipelinesLoadFailed',
  RebuildRequired = 'AnalyticsPipelines.RebuildRequired',
  SectionGroupKeys = 'AnalyticsPipelines.SectionGroupKeys',
  SectionMeasures = 'AnalyticsPipelines.SectionMeasures',
  SectionRuntimeState = 'AnalyticsPipelines.SectionRuntimeState',
  Target = 'AnalyticsPipelines.Target',
  UnclampedRead = 'AnalyticsPipelines.UnclampedRead',
  SectionVariables = 'AnalyticsPipelines.SectionVariables',
  VariablesIn = 'AnalyticsPipelines.VariablesIn',
  VariablesOut = 'AnalyticsPipelines.VariablesOut',
  VarName = 'AnalyticsPipelines.VarName',
  VarColumn = 'AnalyticsPipelines.VarColumn',
  ...
  PlaceholderCovered = 'AnalyticsPipelines.PlaceholderCovered',
  PlaceholderUncovered = 'AnalyticsPipelines.PlaceholderUncovered',
  PlaceholderUnused = 'AnalyticsPipelines.PlaceholderUnused',
  PlaceholderAvailable = 'AnalyticsPipelines.PlaceholderAvailable',
  SectionAdvanced = 'AnalyticsPipelines.SectionAdvanced',
  ScanEvery = 'AnalyticsPipelines.ScanEvery',
  ScanEveryCaption = 'AnalyticsPipelines.ScanEveryCaption',
  RowsPerScan = 'AnalyticsPipelines.RowsPerScan',
  RowsPerCall = 'AnalyticsPipelines.RowsPerCall',
  SampleFraction = 'AnalyticsPipelines.SampleFraction',
  SampleFractionCaption = 'AnalyticsPipelines.SampleFractionCaption',
  SampleFractionInvalid = 'AnalyticsPipelines.SampleFractionInvalid',
  ReadyWhenTitle = 'AnalyticsPipelines.ReadyWhenTitle',
  ReadyWhenTitleCaption = 'AnalyticsPipelines.ReadyWhenTitleCaption',
  ReadyWhenIdleLabel = 'AnalyticsPipelines.ReadyWhenIdleLabel',
  ReadyWhenIdleCaption = 'AnalyticsPipelines.ReadyWhenIdleCaption',
  ReadyWhenSignalLabel = 'AnalyticsPipelines.ReadyWhenSignalLabel',
  PredicateExample = 'AnalyticsPipelines.PredicateExample',
  ReadyWhenStalenessLabel = 'AnalyticsPipelines.ReadyWhenStalenessLabel',
  ReadyWhenStalenessCaption = 'AnalyticsPipelines.ReadyWhenStalenessCaption',
  CostCeilingLabel = 'AnalyticsPipelines.CostCeilingLabel',
  CostCeilingCaption = 'AnalyticsPipelines.CostCeilingCaption',
  DurationCustom = 'AnalyticsPipelines.DurationCustom',
  DurationCustomPlaceholder = 'AnalyticsPipelines.DurationCustomPlaceholder',
  MemberScopeTitle = 'AnalyticsPipelines.MemberScopeTitle',
  MemberScopeCaption = 'AnalyticsPipelines.MemberScopeCaption',
  MemberScopeAll = 'AnalyticsPipelines.MemberScopeAll',
  MemberScopeAllCaption = 'AnalyticsPipelines.MemberScopeAllCaption',
  MemberScopeSelected = 'AnalyticsPipelines.MemberScopeSelected',
  MemberScopeSelectedCaption = 'AnalyticsPipelines.MemberScopeSelectedCaption',
  MemberTiebreak = 'AnalyticsPipelines.MemberTiebreak',
  MemberTiebreakUnresolved = 'AnalyticsPipelines.MemberTiebreakUnresolved',
  SectionOutputs = 'AnalyticsPipelines.SectionOutputs',
  OutputsEmpty = 'AnalyticsPipelines.OutputsEmpty',
  GroupKeysDerived = 'AnalyticsPipelines.GroupKeysDerived',
  MeasureColumnDefault = 'AnalyticsPipelines.MeasureColumnDefault',
  MeasuresColumnsNote = 'AnalyticsPipelines.MeasuresColumnsNote',
}

export enum AnalyticsEvaluatorsI18nKey {
  EvaluatorTypeLlm = 'AnalyticsEvaluators.EvaluatorTypeLlm',
  EvaluatorTypeSql = 'AnalyticsEvaluators.EvaluatorTypeSql',
  ...
  RegisteredAtEvaluator = 'AnalyticsEvaluators.RegisteredAtEvaluator',
  RegisteredAtVersion = 'AnalyticsEvaluators.RegisteredAtVersion',
  Unavailable = 'AnalyticsEvaluators.Unavailable',
  VersionListFailed = 'AnalyticsEvaluators.VersionListFailed',
  Type = 'AnalyticsEvaluators.Type',
  Model = 'AnalyticsEvaluators.Model',
  NotSet = 'AnalyticsEvaluators.NotSet',
  SectionFacts = 'AnalyticsEvaluators.SectionFacts',
  SectionParams = 'AnalyticsEvaluators.SectionParams',
  NoParams = 'AnalyticsEvaluators.NoParams',
  SectionRequestTemplate = 'AnalyticsEvaluators.SectionRequestTemplate',
  SectionOutputVars = 'AnalyticsEvaluators.SectionOutputVars',
  NoOutputVars = 'AnalyticsEvaluators.NoOutputVars',
  OutputProse = 'AnalyticsEvaluators.OutputProse',
  OutputValues = 'AnalyticsEvaluators.OutputValues',
  OutputJsonata = 'AnalyticsEvaluators.OutputJsonata',
  AddOutput = 'AnalyticsEvaluators.AddOutput',
  OutputNameDuplicate = 'AnalyticsEvaluators.OutputNameDuplicate',
  OutputsOrderHint = 'AnalyticsEvaluators.OutputsOrderHint',
  OutputRefinement = 'AnalyticsEvaluators.OutputRefinement',
  OutputValuesAdd = 'AnalyticsEvaluators.OutputValuesAdd',
  OutputValuePlaceholder = 'AnalyticsEvaluators.OutputValuePlaceholder',
  ParamsHint = 'AnalyticsEvaluators.ParamsHint',
  TemplatePlaceholders = 'AnalyticsEvaluators.TemplatePlaceholders',
  TemplatePlaceholdersCaption = 'AnalyticsEvaluators.TemplatePlaceholdersCaption',
  PlaceholderMembers = 'AnalyticsEvaluators.PlaceholderMembers',
  PlaceholderMembersIncluded = 'AnalyticsEvaluators.PlaceholderMembersIncluded',
  PlaceholderMembersOmitted = 'AnalyticsEvaluators.PlaceholderMembersOmitted',
  PlaceholderMembersTruncated = 'AnalyticsEvaluators.PlaceholderMembersTruncated',
  PlaceholderMembersNotice = 'AnalyticsEvaluators.PlaceholderMembersNotice',
  TemplateNotJson = 'AnalyticsEvaluators.TemplateNotJson',
  VarName = 'AnalyticsEvaluators.VarName',
  VarExpression = 'AnalyticsEvaluators.VarExpression',
  UsedByNone = 'AnalyticsEvaluators.UsedByNone',
  UsedByLoadFailed = 'AnalyticsEvaluators.UsedByLoadFailed',
  UsedByUnavailable = 'AnalyticsEvaluators.UsedByUnavailable',
  AddParam = 'AnalyticsEvaluators.AddParam',
  ParamKey = 'AnalyticsEvaluators.ParamKey',
  ParamValue = 'AnalyticsEvaluators.ParamValue',
  NameReadOnly = 'AnalyticsEvaluators.NameReadOnly',
  SaveAsNewVersion = 'AnalyticsEvaluators.SaveAsNewVersion',
  NextVersion = 'AnalyticsEvaluators.NextVersion',
  NextVersionUnknown = 'AnalyticsEvaluators.NextVersionUnknown',
  CreateConfirmTitle = 'AnalyticsEvaluators.CreateConfirmTitle',
  CreateConfirmDescription = 'AnalyticsEvaluators.CreateConfirmDescription',
  Created = 'AnalyticsEvaluators.Created',
  CreateFailed = 'AnalyticsEvaluators.CreateFailed',
...
export enum SessionsTraceI18nKey {
  Title = 'SessionsTrace.Title',
  Session = 'SessionsTrace.Session',
  SessionHint = 'SessionsTrace.SessionHint',
  Project = 'SessionsTrace.Project',
  NoProject = 'SessionsTrace.NoProject',
  NoTitle = 'SessionsTrace.NoTitle',
  Turns = 'SessionsTrace.Turns',
  TurnsHint = 'SessionsTrace.TurnsHint',
  Activity = 'SessionsTrace.Activity',
  Tokens = 'SessionsTrace.Tokens',
  Cost = 'SessionsTrace.Cost',
  DurationHint = 'SessionsTrace.DurationHint',
  AvgDurationHint = 'SessionsTrace.AvgDurationHint',
  Deployments = 'SessionsTrace.Deployments',
  DeploymentsHint = 'SessionsTrace.DeploymentsHint',
  Topics = 'SessionsTrace.Topics',
  TopicsHint = 'SessionsTrace.TopicsHint',
  NoSessions = 'SessionsTrace.NoSessions',
  SessionsLoadFailed = 'SessionsTrace.SessionsLoadFailed',
  SearchPlaceholder = 'SessionsTrace.SearchPlaceholder',
  Feedback = 'SessionsTrace.Feedback',
  FeedbackAll = 'SessionsTrace.FeedbackAll',
  FeedbackPositive = 'SessionsTrace.FeedbackPositive',
  FeedbackNegative = 'SessionsTrace.FeedbackNegative',
  FeedbackRated = 'SessionsTrace.FeedbackRated',
  ProvenanceSessions = 'SessionsTrace.ProvenanceSessions',
  ProvenanceSessionsHint = 'SessionsTrace.ProvenanceSessionsHint',
  ProvenanceInsights = 'SessionsTrace.ProvenanceInsights',
  ProvenanceInsightsHint = 'SessionsTrace.ProvenanceInsightsHint',
  ProvenanceFeedback = 'SessionsTrace.ProvenanceFeedback',
  ProvenanceFeedbackHint = 'SessionsTrace.ProvenanceFeedbackHint',
  ProvenanceEnrichmentHint = 'SessionsTrace.ProvenanceEnrichmentHint',
  TagIdentity = 'SessionsTrace.TagIdentity',
  TagPrincipal = 'SessionsTrace.TagPrincipal',
  TagResponse = 'SessionsTrace.TagResponse',
  TagTokenUsage = 'SessionsTrace.TagTokenUsage',
  TagCost = 'SessionsTrace.TagCost',
  TagPerformance = 'SessionsTrace.TagPerformance',
  TagDeployment = 'SessionsTrace.TagDeployment',
  TagInsight = 'SessionsTrace.TagInsight',
  TagProvenance = 'SessionsTrace.TagProvenance',
  Rating = 'SessionsTrace.Rating',
  ComposedOver = 'SessionsTrace.ComposedOver',
  SummarySessions = 'SessionsTrace.SummarySessions',
  SummaryRated = 'SessionsTrace.SummaryRated',
  SummaryWith = 'SessionsTrace.SummaryWith',
  SummaryCost = 'SessionsTrace.SummaryCost',
  SummaryPeriodHint = 'SessionsTrace.SummaryPeriodHint',
  SummaryPendingHint = 'SessionsTrace.SummaryPendingHint',
  FeedbackCappedNotice = 'SessionsTrace.FeedbackCappedNotice',
  SchemaLoadFailed = 'SessionsTrace.SchemaLoadFailed',
  SummaryUnavailableHint = 'SessionsTrace.SummaryUnavailableHint',
  RatingUp = 'SessionsTrace.RatingUp',
  RatingDown = 'SessionsTrace.RatingDown',
  RatingUpTotal = 'SessionsTrace.RatingUpTotal',
  RatingDownTotal = 'SessionsTrace.RatingDownTotal',
  RatingDownCaveat = 'SessionsTrace.RatingDownCaveat',
  DetailLoadFailed = 'SessionsTrace.DetailLoadFailed',
  DetailNotRecorded = 'SessionsTrace.DetailNotRecorded',
  DetailEmptyValue = 'SessionsTrace.DetailEmptyValue',
  DetailId = 'SessionsTrace.DetailId',
  DetailDuration = 'SessionsTrace.DetailDuration',
  DetailLastActivity = 'SessionsTrace.DetailLastActivity',
  DetailPanelInsights = 'SessionsTrace.DetailPanelInsights',
  DetailPanelUsage = 'SessionsTrace.DetailPanelUsage',
  DetailPanelFeedback = 'SessionsTrace.DetailPanelFeedback',
  DetailPanelMetadata = 'SessionsTrace.DetailPanelMetadata',
  DetailInsightsNotEvaluated = 'SessionsTrace.DetailInsightsNotEvaluated',
  DetailInsightsUnavailable = 'SessionsTrace.DetailInsightsUnavailable',
  DetailTokensIn = 'SessionsTrace.DetailTokensIn',
  DetailTokensOut = 'SessionsTrace.DetailTokensOut',
  DetailTotalTokens = 'SessionsTrace.DetailTotalTokens',
  DetailUser = 'SessionsTrace.DetailUser',
  DetailStarted = 'SessionsTrace.DetailStarted',
  DetailSuccessful = 'SessionsTrace.DetailSuccessful',
  DetailTrace = 'SessionsTrace.DetailTrace',
  DetailDeployment = 'SessionsTrace.DetailDeployment',
  DetailTurn = 'SessionsTrace.DetailTurn',
  DetailComment = 'SessionsTrace.DetailComment',
  DetailCommentCount = 'SessionsTrace.DetailCommentCount',
  DetailCommentCountOne = 'SessionsTrace.DetailCommentCountOne',
  DetailCommentRestricted = 'SessionsTrace.DetailCommentRestricted',
  DetailNoComments = 'SessionsTrace.DetailNoComments',
  DetailRatingContested = 'SessionsTrace.DetailRatingContested',
  DetailRatingNoValue = 'SessionsTrace.DetailRatingNoValue',
  DetailRatingWindow = 'SessionsTrace.DetailRatingWindow',
  DetailRatingPositive = 'SessionsTrace.DetailRatingPositive',
  DetailRatingNegative = 'SessionsTrace.DetailRatingNegative',
  DetailNoRatings = 'SessionsTrace.DetailNoRatings',
  DetailFeedbackPartial = 'SessionsTrace.DetailFeedbackPartial',
  SpanRoute = 'SessionsTrace.SpanRoute',
  SpanOther = 'SessionsTrace.SpanOther',
  TraceBackToList = 'SessionsTrace.TraceBackToList',
  TraceListEmpty = 'SessionsTrace.TraceListEmpty',
  TraceListLoadFailed = 'SessionsTrace.TraceListLoadFailed',
  TraceCardOwnPrice = 'SessionsTrace.TraceCardOwnPrice',
  TraceCardChainPrice = 'SessionsTrace.TraceCardChainPrice',
  TraceCardMessages = 'SessionsTrace.TraceCardMessages',
  TraceCardCoreInternal = 'SessionsTrace.TraceCardCoreInternal',
  TraceCardFailed = 'SessionsTrace.TraceCardFailed',
  TraceCardSucceeded = 'SessionsTrace.TraceCardSucceeded',
  TraceRootNotRecorded = 'SessionsTrace.TraceRootNotRecorded',
  TraceRootNotRecordedHint = 'SessionsTrace.TraceRootNotRecordedHint',
  TraceFailuresInside = 'SessionsTrace.TraceFailuresInside',
  TraceFurtherCalls = 'SessionsTrace.TraceFurtherCalls',
  TraceChipUnclassified = 'SessionsTrace.TraceChipUnclassified',
  TraceGroupLabel = 'SessionsTrace.TraceGroupLabel',
  TraceListLoadMore = 'SessionsTrace.TraceListLoadMore',
  TraceListEmptyHintLive = 'SessionsTrace.TraceListEmptyHintLive',
  TraceListLoadFailedHint = 'SessionsTrace.TraceListLoadFailedHint',
  TraceSectionTitle = 'SessionsTrace.TraceSectionTitle',
  TraceSectionRule = 'SessionsTrace.TraceSectionRule',
  TraceCardStarted = 'SessionsTrace.TraceCardStarted',
  TraceCardSpans = 'SessionsTrace.TraceCardSpans',
  TraceCardOwnTokens = 'SessionsTrace.TraceCardOwnTokens',
  TraceDuration = 'SessionsTrace.TraceDuration',
  TraceTokens = 'SessionsTrace.TraceTokens',
  TraceCost = 'SessionsTrace.TraceCost',
  TraceSpans = 'SessionsTrace.TraceSpans',
  TraceStatus = 'SessionsTrace.TraceStatus',
  TraceOk = 'SessionsTrace.TraceOk',
  TraceFailed = 'SessionsTrace.TraceFailed',
  TraceSpansPartial = 'SessionsTrace.TraceSpansPartial',
  TraceLoadFailed = 'SessionsTrace.TraceLoadFailed',
  TraceNoSpans = 'SessionsTrace.TraceNoSpans',
  SpanRecordedAt = 'SessionsTrace.SpanRecordedAt',
  SpanCostOwn = 'SessionsTrace.SpanCostOwn',
  SpanCostChain = 'SessionsTrace.SpanCostChain',
  SpanFieldsUnavailable = 'SessionsTrace.SpanFieldsUnavailable',
  SpanJsonOpen = 'SessionsTrace.SpanJsonOpen',
  SpanTagIdentifier = 'SessionsTrace.SpanTagIdentifier',
  SpanTagDimension = 'SessionsTrace.SpanTagDimension',
  SpanTagPrincipal = 'SessionsTrace.SpanTagPrincipal',
  SpanTagDeployment = 'SessionsTrace.SpanTagDeployment',
  SpanTagRequest = 'SessionsTrace.SpanTagRequest',
  SpanTagResponse = 'SessionsTrace.SpanTagResponse',
  SpanTagTokenUsage = 'SessionsTrace.SpanTagTokenUsage',
  SpanTagCost = 'SessionsTrace.SpanTagCost',
  SpanTagPerformance = 'SessionsTrace.SpanTagPerformance',
  SpanTagClient = 'SessionsTrace.SpanTagClient',
  SpanTagProvenance = 'SessionsTrace.SpanTagProvenance',
  SpanTagTracing = 'SessionsTrace.SpanTagTracing',
  SpanTagSystem = 'SessionsTrace.SpanTagSystem',
  SpanTagOther = 'SessionsTrace.SpanTagOther',
  InspectorRequest = 'SessionsTrace.InspectorRequest',
  InspectorResponse = 'SessionsTrace.InspectorResponse',
  InspectorTabsLabel = 'SessionsTrace.InspectorTabsLabel',
  InspectorLoading = 'SessionsTrace.InspectorLoading',
  InspectorRolesLabel = 'SessionsTrace.InspectorRolesLabel',
  InspectorRoleAll = 'SessionsTrace.InspectorRoleAll',
  InspectorRoleSystem = 'SessionsTrace.InspectorRoleSystem',
  InspectorRoleUser = 'SessionsTrace.InspectorRoleUser',
  InspectorRoleAssistant = 'SessionsTrace.InspectorRoleAssistant',
  InspectorRoleTool = 'SessionsTrace.InspectorRoleTool',
  InspectorRoleOther = 'SessionsTrace.InspectorRoleOther',
  InspectorRoleMatches = 'SessionsTrace.InspectorRoleMatches',
  InspectorParamTemperature = 'SessionsTrace.InspectorParamTemperature',
  InspectorParamMaxTokens = 'SessionsTrace.InspectorParamMaxTokens',
  InspectorParamTools = 'SessionsTrace.InspectorParamTools',
  InspectorParamStream = 'SessionsTrace.InspectorParamStream',
  InspectorParamsLabel = 'SessionsTrace.InspectorParamsLabel',
  InspectorParamsRest = 'SessionsTrace.InspectorParamsRest',
  InspectorParamMessages = 'SessionsTrace.InspectorParamMessages',
  InspectorToolCall = 'SessionsTrace.InspectorToolCall',
  InspectorNoText = 'SessionsTrace.InspectorNoText',
  InspectorShowFullMessage = 'SessionsTrace.InspectorShowFullMessage',
  InspectorHideFullMessage = 'SessionsTrace.InspectorHideFullMessage',
  InspectorEnvelopeClamped = 'SessionsTrace.InspectorEnvelopeClamped',
  InspectorNoMessages = 'SessionsTrace.InspectorNoMessages',
  InspectorRaw = 'SessionsTrace.InspectorRaw',
  InspectorResponseFactsLabel = 'SessionsTrace.InspectorResponseFactsLabel',
  InspectorUpstreamModel = 'SessionsTrace.InspectorUpstreamModel',
  InspectorPromptTokens = 'SessionsTrace.InspectorPromptTokens',
  InspectorCompletionTokens = 'SessionsTrace.InspectorCompletionTokens',
  InspectorCachedTokens = 'SessionsTrace.InspectorCachedTokens',
  InspectorFinishReason = 'SessionsTrace.InspectorFinishReason',
  InspectorReasoning = 'SessionsTrace.InspectorReasoning',
  InspectorRawClamped = 'SessionsTrace.InspectorRawClamped',
  InspectorUnstructured = 'SessionsTrace.InspectorUnstructured',
  InspectorWithheldRequest = 'SessionsTrace.InspectorWithheldRequest',
  InspectorWithheldResponse = 'SessionsTrace.InspectorWithheldResponse',
  InspectorWithheldStats = 'SessionsTrace.InspectorWithheldStats',
  InspectorWithheldValue = 'SessionsTrace.InspectorWithheldValue',
  InspectorNoBody = 'SessionsTrace.InspectorNoBody',
  InspectorLoadFailed = 'SessionsTrace.InspectorLoadFailed',
  InspectorNoResponse = 'SessionsTrace.InspectorNoResponse',
  InspectorProtocolNoBody = 'SessionsTrace.InspectorProtocolNoBody',
  InspectorVector = 'SessionsTrace.InspectorVector',
  InspectorMcpMethod = 'SessionsTrace.InspectorMcpMethod',
  InspectorMcpTool = 'SessionsTrace.InspectorMcpTool',
  InspectorMcpToolset = 'SessionsTrace.InspectorMcpToolset',
  InspectorMcpArguments = 'SessionsTrace.InspectorMcpArguments',
  InspectorMcpResult = 'SessionsTrace.InspectorMcpResult',
  InspectorEmbeddingModel = 'SessionsTrace.InspectorEmbeddingModel',
  InspectorEmbeddingInputs = 'SessionsTrace.InspectorEmbeddingInputs',
  InspectorEmbeddingDimensions = 'SessionsTrace.InspectorEmbeddingDimensions',
  InspectorEmbeddingText = 'SessionsTrace.InspectorEmbeddingText',
  InspectorMcpFactsLabel = 'SessionsTrace.InspectorMcpFactsLabel',
  InspectorProtocolParams = 'SessionsTrace.InspectorProtocolParams',
  InspectorProtocolNoParams = 'SessionsTrace.InspectorProtocolNoParams',
  InspectorProtocolResult = 'SessionsTrace.InspectorProtocolResult',
  InspectorTransportLabel = 'SessionsTrace.InspectorTransportLabel',
  InspectorTransportStatus = 'SessionsTrace.InspectorTransportStatus',
  InspectorTransportMethod = 'SessionsTrace.InspectorTransportMethod',
  InspectorTransportSent = 'SessionsTrace.InspectorTransportSent',
  InspectorTransportReceived = 'SessionsTrace.InspectorTransportReceived',
  InspectorTransportTook = 'SessionsTrace.InspectorTransportTook',
  InspectorToolAnswers = 'SessionsTrace.InspectorToolAnswers',
  InspectorToolFailed = 'SessionsTrace.InspectorToolFailed',
  InspectorChat = 'SessionsTrace.InspectorChat',
  InspectorChatLabel = 'SessionsTrace.InspectorChatLabel',
  InspectorChatNoMessages = 'SessionsTrace.InspectorChatNoMessages',
  InspectorChatAnswerWithheld = 'SessionsTrace.InspectorChatAnswerWithheld',
  InspectorChatHopFailed = 'SessionsTrace.InspectorChatHopFailed',
  BodiesSplitLabel = 'SessionsTrace.BodiesSplitLabel',
  SpanLlm = 'SessionsTrace.SpanLlm',
  SpanEmbeddings = 'SessionsTrace.SpanEmbeddings',
  SpanMcp = 'SessionsTrace.SpanMcp',
  EventFailed = 'SessionsTrace.EventFailed',
  SpanFailedMarker = 'SessionsTrace.SpanFailedMarker',
  SpanRating = 'SessionsTrace.SpanRating',
  SpanTokens = 'SessionsTrace.SpanTokens',
  SpanChainCost = 'SessionsTrace.SpanChainCost',
  SpanRequestMessages = 'SessionsTrace.SpanRequestMessages',
  InspectorToolNotRecorded = 'SessionsTrace.InspectorToolNotRecorded',
  StreamTabAll = 'SessionsTrace.StreamTabAll',
  StreamFilterLabel = 'SessionsTrace.StreamFilterLabel',
  StreamLabel = 'SessionsTrace.StreamLabel',
  StreamMatchCount = 'SessionsTrace.StreamMatchCount',
  StreamMatch = 'SessionsTrace.StreamMatch',
  TreeExpand = 'SessionsTrace.TreeExpand',
  TreeCollapse = 'SessionsTrace.TreeCollapse',
  SpanEndpoint = 'SessionsTrace.SpanEndpoint',
  SpanUpstream = 'SessionsTrace.SpanUpstream',
  SpanSelected = 'SessionsTrace.SpanSelected',
  DetailAvgDuration = 'SessionsTrace.DetailAvgDuration',
  DetailTurns = 'SessionsTrace.DetailTurns',
  ValueFilterGroup = 'SessionsTrace.ValueFilterGroup',
  ValueFilterLoading = 'SessionsTrace.ValueFilterLoading',
  ValueFilterEmpty = 'SessionsTrace.ValueFilterEmpty',
  ValueFilterLoadFailed = 'SessionsTrace.ValueFilterLoadFailed',
  ValuesLoadFailed = 'SessionsTrace.ValuesLoadFailed',
  ValueFilterSearch = 'SessionsTrace.ValueFilterSearch',
  ValueFilterSelectAll = 'SessionsTrace.ValueFilterSelectAll',
}

export enum AnalyticsUsageI18nKey {
  ViewByLabel = 'AnalyticsUsage.ViewByLabel',
  ViewMcp = 'AnalyticsUsage.ViewMcp',
  ...
  TimeSeriesEmptyHint = 'AnalyticsUsage.TimeSeriesEmptyHint',
  DonutEmptySubtitle = 'AnalyticsUsage.DonutEmptySubtitle',
  DonutEmptyCenter = 'AnalyticsUsage.DonutEmptyCenter',
  HeatmapEmptySubtitle = 'AnalyticsUsage.HeatmapEmptySubtitle',
  BreakdownFullListHeader = 'AnalyticsUsage.BreakdownFullListHeader',
  BreakdownEmptyTitle = 'AnalyticsUsage.BreakdownEmptyTitle',
  BreakdownEmptyBody = 'AnalyticsUsage.BreakdownEmptyBody',
  TimeSeriesTabRequests = 'AnalyticsUsage.TimeSeriesTabRequests',
  TimeSeriesTabSplit = 'AnalyticsUsage.TimeSeriesTabSplit',
  TimeSeriesTabCost = 'AnalyticsUsage.TimeSeriesTabCost',
  TimeSeriesTabLatency = 'AnalyticsUsage.TimeSeriesTabLatency',
  TimeSeriesSplitTitle = 'AnalyticsUsage.TimeSeriesSplitTitle',
  TimeSeriesSplitSubtitle = 'AnalyticsUsage.TimeSeriesSplitSubtitle',
  TimeSeriesCostTitle = 'AnalyticsUsage.TimeSeriesCostTitle',
  TimeSeriesCostSubtitle = 'AnalyticsUsage.TimeSeriesCostSubtitle',
  TimeSeriesLatencyTitle = 'AnalyticsUsage.TimeSeriesLatencyTitle',
  TimeSeriesLatencySubtitle = 'AnalyticsUsage.TimeSeriesLatencySubtitle',
  TimeSeriesLatencyP50 = 'AnalyticsUsage.TimeSeriesLatencyP50',
  TimeSeriesLatencyP95 = 'AnalyticsUsage.TimeSeriesLatencyP95',

  HeatmapTitle = 'AnalyticsUsage.HeatmapTitle',
  HeatmapSubtitle = 'AnalyticsUsage.HeatmapSubtitle',
  ...
  DonutTitle = 'AnalyticsUsage.DonutTitle',
  ...
  BreakdownTabApplications = 'AnalyticsUsage.BreakdownTabApplications',
  BreakdownTabProjects = 'AnalyticsUsage.BreakdownTabProjects',
  BreakdownTabMcpServers = 'AnalyticsUsage.BreakdownTabMcpServers',
  ...
  ColumnAvgLatency = 'AnalyticsUsage.ColumnAvgLatency',
  ColumnProject = 'AnalyticsUsage.ColumnProject',
  ColumnMcpServer = 'AnalyticsUsage.ColumnMcpServer',
  ColumnTool = 'AnalyticsUsage.ColumnTool',
  ColumnCost = 'AnalyticsUsage.ColumnCost',
  BreakdownDescriptionModels = 'AnalyticsUsage.BreakdownDescriptionModels',
  BreakdownDescriptionApplications = 'AnalyticsUsage.BreakdownDescriptionApplications',
  BreakdownDescriptionProjects = 'AnalyticsUsage.BreakdownDescriptionProjects',
  BreakdownDescriptionMcpServers = 'AnalyticsUsage.BreakdownDescriptionMcpServers',
  ...
  PanelShareOfCalls = 'AnalyticsUsage.PanelShareOfCalls',

  NoProject = 'AnalyticsUsage.NoProject',
  NoProjectTooltip = 'AnalyticsUsage.NoProjectTooltip',
