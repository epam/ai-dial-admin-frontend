...
export enum RunsI18nKey {
  ...
  // Turn-scoped variants, used when the run contains multi-turn test cases (per-turn eval summaries).
  MetricScoresDescriptionAvgTurns = 'Runs.MetricScoresDescriptionAvgTurns',
  MetricScoresDescriptionP90Turns = 'Runs.MetricScoresDescriptionP90Turns',
  MetricScoresDescriptionP10Turns = 'Runs.MetricScoresDescriptionP10Turns',
  MetricScoresDescriptionMaxTurns = 'Runs.MetricScoresDescriptionMaxTurns',
  MetricScoresDescriptionMinTurns = 'Runs.MetricScoresDescriptionMinTurns',
  MetricScoresDescriptionMedTurns = 'Runs.MetricScoresDescriptionMedTurns',
  MetricScoresDescriptionCountTurns = 'Runs.MetricScoresDescriptionCountTurns',
  ...
  DistributionValueTitleTurns = 'Runs.DistributionValueTitleTurns',
  SelectMetricToSeeDistribution = 'Runs.SelectMetricToSeeDistribution',
  TestCasesPassed = 'Runs.TestCasesPassed',
  TestCaseTurnsPassed = 'Runs.TestCaseTurnsPassed',
  AvgTestCaseRunTime = 'Runs.AvgTestCaseRunTime',
  AvgTestCaseTurnRunTime = 'Runs.AvgTestCaseTurnRunTime',
  AvgPerTestCase = 'Runs.AvgPerTestCase',
  AvgPerTestCaseTurn = 'Runs.AvgPerTestCaseTurn',
  Pass = 'Runs.Pass',
  Fail = 'Runs.Fail',
