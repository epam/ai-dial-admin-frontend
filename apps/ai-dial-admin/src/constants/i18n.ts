...
export enum AnalyticsPipelinesI18nKey {
  ...
  SectionTransform = 'AnalyticsPipelines.SectionTransform',
  ResponseSchema = 'AnalyticsPipelines.ResponseSchema',
  TransformType = 'AnalyticsPipelines.TransformType',
  TransformTypeLlm = 'AnalyticsPipelines.TransformTypeLlm',
  TransformTypeSql = 'AnalyticsPipelines.TransformTypeSql',
  TransformEmpty = 'AnalyticsPipelines.TransformEmpty',
  Model = 'AnalyticsPipelines.Model',
  SectionParams = 'AnalyticsPipelines.SectionParams',
  NoParams = 'AnalyticsPipelines.NoParams',
  ParamsHint = 'AnalyticsPipelines.ParamsHint',
  AddParam = 'AnalyticsPipelines.AddParam',
  ParamKey = 'AnalyticsPipelines.ParamKey',
  ParamValue = 'AnalyticsPipelines.ParamValue',
  SectionRequestTemplate = 'AnalyticsPipelines.SectionRequestTemplate',
  TemplateNotJson = 'AnalyticsPipelines.TemplateNotJson',
  TemplatePlaceholders = 'AnalyticsPipelines.TemplatePlaceholders',
  TemplatePlaceholdersCaption = 'AnalyticsPipelines.TemplatePlaceholdersCaption',
  PlaceholderMembers = 'AnalyticsPipelines.PlaceholderMembers',
  PlaceholderMembersIncluded = 'AnalyticsPipelines.PlaceholderMembersIncluded',
  PlaceholderMembersOmitted = 'AnalyticsPipelines.PlaceholderMembersOmitted',
  PlaceholderMembersTruncated = 'AnalyticsPipelines.PlaceholderMembersTruncated',
  PlaceholderMembersNotice = 'AnalyticsPipelines.PlaceholderMembersNotice',
  OutputColumn = 'AnalyticsPipelines.OutputColumn',
  OutputColumnMissing = 'AnalyticsPipelines.OutputColumnMissing',
  OutputProse = 'AnalyticsPipelines.OutputProse',
  OutputProseFromColumn = 'AnalyticsPipelines.OutputProseFromColumn',
  OutputValues = 'AnalyticsPipelines.OutputValues',
  OutputValuesAdd = 'AnalyticsPipelines.OutputValuesAdd',
  OutputValuePlaceholder = 'AnalyticsPipelines.OutputValuePlaceholder',
  OutputJsonata = 'AnalyticsPipelines.OutputJsonata',
  OutputJsonataIdentity = 'AnalyticsPipelines.OutputJsonataIdentity',
  OutputRefinement = 'AnalyticsPipelines.OutputRefinement',
  OutputNameDuplicate = 'AnalyticsPipelines.OutputNameDuplicate',
  OutputsOrderHint = 'AnalyticsPipelines.OutputsOrderHint',
  AddOutput = 'AnalyticsPipelines.AddOutput',
  NoOutputs = 'AnalyticsPipelines.NoOutputs',
  VarExpression = 'AnalyticsPipelines.VarExpression',
  DeleteConfirmDescriptionEnrich = 'AnalyticsPipelines.DeleteConfirmDescriptionEnrich',
}
