...
export enum TestSuitesI18nKey {
  ...
  CasesPassed = 'TestSuites.CasesPassed',
  CasesPassedCaption = 'TestSuites.CasesPassedCaption',
  CasePassRateLatestRun = 'TestSuites.CasePassRateLatestRun',
  CasePassRateInProgress = 'TestSuites.CasePassRateInProgress',
  CasePassRateNotRun = 'TestSuites.CasePassRateNotRun',
  CasePassRateVsPrev = 'TestSuites.CasePassRateVsPrev',
  CasePassRateLackScoring = 'TestSuites.CasePassRateLackScoring',
  CasePassRateUnavailable = 'TestSuites.CasePassRateUnavailable',
  CasePassRateBarLabel = 'TestSuites.CasePassRateBarLabel',
