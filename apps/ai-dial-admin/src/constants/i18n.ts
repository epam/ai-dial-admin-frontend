...
export enum ConversationsTraceI18nKey {
  ...
  SpanRouting = 'ConversationsTrace.SpanRouting',
  SpanMcpMethod = 'ConversationsTrace.SpanMcpMethod',
  SpanMcpTool = 'ConversationsTrace.SpanMcpTool',
  ...
  SpanParent = 'ConversationsTrace.SpanParent',
