...
export enum AnalyticsPipelinesI18nKey {
  ...
  SectionScope = 'AnalyticsPipelines.SectionScope',
  ...
  ClampedByTitle = 'AnalyticsPipelines.ClampedByTitle',
  ...
  RebuildRequiredTitle = 'AnalyticsPipelines.RebuildRequiredTitle',
  RebuildRequired = 'AnalyticsPipelines.RebuildRequired',
  LastErrorTitle = 'AnalyticsPipelines.LastErrorTitle',
