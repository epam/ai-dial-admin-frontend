...
export enum ConversationsTraceI18nKey {
  ...
  Sentiment = 'ConversationsTrace.Sentiment',
  SentimentScore = 'ConversationsTrace.SentimentScore',
  Topic = 'ConversationsTrace.Topic',
  Topics = 'ConversationsTrace.Topics',
  Language = 'ConversationsTrace.Language',
  ResolutionStatus = 'ConversationsTrace.ResolutionStatus',
  InsightHint = 'ConversationsTrace.InsightHint',
  CacheCreationTokens = 'ConversationsTrace.CacheCreationTokens',
  CachedPromptTokens = 'ConversationsTrace.CachedPromptTokens',
  ReasoningTokens = 'ConversationsTrace.ReasoningTokens',
  ChainCost = 'ConversationsTrace.ChainCost',
  ChainCostHint = 'ConversationsTrace.ChainCostHint',
