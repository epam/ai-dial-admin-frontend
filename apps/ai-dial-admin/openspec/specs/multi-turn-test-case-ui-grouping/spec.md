# multi-turn-test-case-ui-grouping Specification

## Purpose
Define how the test-case grids group flat backend rows into logical single- and multi-turn test cases,
auto-manage the conversation-grouping keys, and expose collapsible, filterable, and editable turn views.
