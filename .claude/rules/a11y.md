...
#   Cursor      (.cursor/rules/a11y.mdc symlinks here)                  -> `alwaysApply: true`
#   Copilot     (.github/instructions/a11y.instructions.md symlinks here) -> `applyTo: "**"`
# Editing the body updates every tool at once (the others are symlinks). Always-on because an
