...
#   Cursor      (.cursor/rules/a11y.mdc stubs to here)            -> `alwaysApply: true`
#   Copilot     (.github/instructions/a11y.instructions.md is a copy)    -> `applyTo: "**"`
# Edit only here — pre-commit regenerates both mirrors. Always-on because an
