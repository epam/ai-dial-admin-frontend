...
#   Cursor      (.cursor/rules/components.mdc stubs to here)             -> `globs` / `alwaysApply` / `description`
#   Copilot     (.github/instructions/components.instructions.md is a copy)     -> `applyTo`
